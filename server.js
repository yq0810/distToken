...
(function($PS) {
  ...
  var genericTransactionStatus = new Data_Generic_Rep.Generic(function (x) {
      if (x instanceof Succeeded) {
          return new Data_Generic_Rep.Inl(Data_Generic_Rep.NoArguments.value);
      };
      if (x instanceof Failed) {
          return new Data_Generic_Rep.Inr(Data_Generic_Rep.NoArguments.value);
      };
      throw new Error("Failed pattern match at Network.Ethereum.Web3.Types.Types (line 198, column 1 - line 198, column 72): " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
  ...
  var showTransactionStatus = new Data_Show.Show(Data_Generic_Rep_Show.genericShow(genericTransactionStatus)(Data_Generic_Rep_Show.genericShowSum(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsNoArguments)(new Data_Symbol.IsSymbol(function () {
      return "Succeeded";
  ...
  var showChange = new Data_Show.Show(Data_Generic_Rep_Show.genericShow(genericChange)(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsArgument(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
      return "address";
  }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
      return "blockHash";
  }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
  ...
  }))(Data_Show.showRecordFieldsNil)(Network_Ethereum_Core_BigNumber.showBigNumber))(Network_Ethereum_Core_HexString.showHexString))(Data_Show.showArray(Network_Ethereum_Core_HexString.showHexString)))(Data_Show.showBoolean))(Network_Ethereum_Core_BigNumber.showBigNumber))(Network_Ethereum_Core_HexString.showHexString))(showBlockNumber))(Network_Ethereum_Core_HexString.showHexString))(Network_Ethereum_Core_Signatures.addressShow))))(new Data_Symbol.IsSymbol(function () {
      return "Change";
  }))));
  ...
  exports["showTransactionStatus"] = showTransactionStatus;
...
(function($PS) {
  ...
  var Refresh$prime = (function () {
      function Refresh$prime() {

      };
      Refresh$prime.value = new Refresh$prime();
      return Refresh$prime;
  })();
          ...
          return function (message) {
              var render = function (s) {
                  var stateText = (function () {
                      ...
                      throw new Error("Failed pattern match at UI.Component.Header.Component (line 126, column 17 - line 133, column 49): " + [ s.networkState.constructor.name ]);
                  })();
                  var connectHTML = function (v) {
                      ...
                      throw new Error("Failed pattern match at UI.Component.Header.Component (line 114, column 15 - line 119, column 53): " + [ v.constructor.name ]);
                  };
              ...
              var handleAction = function (v) {
                  if (v instanceof Refresh$prime) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          return v1.messages;
                      }))(function (messages) {
                          if (messages instanceof Data_Maybe.Just) {
                              return Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Effect_Aff_Bus.write(PublicMsg.create(Refresh.value))(messages.value0));
                          };
                          if (messages instanceof Data_Maybe.Nothing) {
                              return Partial_Unsafe.unsafeCrashWith("wait bus");
                          };
                          throw new Error("Failed pattern match at UI.Component.Header.Component (line 163, column 9 - line 166, column 50): " + [ messages.constructor.name ]);
                      });
                  };
                  if (v instanceof Connect) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                                      ...
                                      return function __do() {
                                          Effect_Aff.launchAff_(Control_Lazy.fix(Effect_Aff.lazyAff)(function (loop) {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(500.0))(function () {
                                                  ...
                                                  throw new Error("Failed pattern match at UI.Component.Header.Component (line 175, column 17 - line 179, column 53): " + [ v1.constructor.name ]);
                                              });
                                          }))();
                          ...
                          throw new Error("Failed pattern match at UI.Component.Header.Component (line 169, column 9 - line 183, column 42): " + [ messages.constructor.name ]);
                      });
                  };
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Reader_Class.ask(Halogen_Query_HalogenM.monadAskHalogenM(dictMonadAsk)))(function (v1) {
                          if (v1.maybeWeb3Provider instanceof Data_Maybe.Nothing) {
                              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                  ...
                                  $32.networkState = Disconnected.value;
                                  return $32;
                              });
                          };
                              ...
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Network_Ethereum_Web3_Types_Types.runWeb3(v1.maybeWeb3Provider.value0)(Network_Ethereum_Web3_Api.net_version)))(function (netID) {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                      ...
                                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                          ...
                                          $38.networkState = state;
                                          return $38;
                                      });
                                  });
                              });
                          };
                          throw new Error("Failed pattern match at UI.Component.Header.Component (line 188, column 9 - line 201, column 52): " + [ v1.maybeWeb3Provider.constructor.name ]);
                      });
                  };
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          if (messages instanceof Data_Maybe.Just) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                                  ...
                                  $44.account = new Data_Maybe.Just(v.value0);
                                  return $44;
                              }))(function () {
                          ...
                          throw new Error("Failed pattern match at UI.Component.Header.Component (line 204, column 9 - line 208, column 50): " + [ messages.constructor.name ]);
                      });
                  };
                  throw new Error("Failed pattern match at UI.Component.Header.Component (line 160, column 20 - line 208, column 50): " + [ v.constructor.name ]);
              };
              var handleQuery = function (v) {
                  ...
                  if (v instanceof GiveBusW) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $51.messages = new Data_Maybe.Just(v.value0);
                          return $51;
                      }))(function () {
                  ...
                  throw new Error("Failed pattern match at UI.Component.Header.Component (line 145, column 19 - line 155, column 22): " + [ v.constructor.name ]);
              };
...
(function($PS) {
  ...
  var uIntNFromBigNumber$prime = function (dictKnownSize) {
      return function (s) {
          return function (n) {
              ...
              throw new Error("Failed pattern match at UI.Component.RelayableNFT.Types (line 69, column 27 - line 71, column 14): " + [ v.constructor.name ]);
          };
      };
  };
  var tableEntryView = function (v) {
      return {
          "_type": "Shared",
          sharer: v.value0.sharerAddress,
          shareVolume: v.value0.shareVolume,
  ...
  var intToBigNumber = function (x) {
      ...
      throw new Error("Failed pattern match at UI.Component.RelayableNFT.Types (line 51, column 20 - line 53, column 14): " + [ v.constructor.name ]);
  };
  var intToWeiBigNumber = function (n) {
      return function (dec) {
          return Data_Semiring.mul(Network_Ethereum_Core_BigNumber.semiringBigNumber)(intToBigNumber(n))(Network_Ethereum_Core_BigNumber.pow(intToBigNumber(10))(dec));
      };
  };
  var bigNumberToInt = function (x) {
      var v = Data_Int_Parse["parseInt"](Data_Show.show(Network_Ethereum_Core_BigNumber.showBigNumber)(x))(Data_Int_Parse.toRadix(10));
      if (v instanceof Data_Maybe.Nothing) {
      ...
      throw new Error("Failed pattern match at UI.Component.RelayableNFT.Types (line 60, column 20 - line 62, column 14): " + [ v.constructor.name ]);
  };
  var weiBigNumberToInt = function (n) {
      return function (dec) {
          return bigNumberToInt(Data_EuclideanRing.div(Network_Ethereum_Core_BigNumber.euclidianRingBigNumber)(n)(Network_Ethereum_Core_BigNumber.pow(intToBigNumber(10))(dec)));
      };
  };
  var bigNumberToFloat = function (x) {
      ...
      throw new Error("Failed pattern match at UI.Component.RelayableNFT.Types (line 65, column 22 - line 67, column 14): " + [ v.constructor.name ]);
  };
  var weiBigNumberFiexed2 = function (n) {
      return function (dec) {
          return bigNumberToFloat(Data_EuclideanRing.div(Network_Ethereum_Core_BigNumber.euclidianRingBigNumber)(n)(Network_Ethereum_Core_BigNumber.pow(intToBigNumber(10))(dec - 2 | 0))) / 100.0;
      };
  };
  var weiBigNumberToStringFiexed2 = function (n) {
      return function (dec) {
          return Data_Number_Format.toStringWith(Data_Number_Format.fixed(2))(bigNumberToFloat(Data_EuclideanRing.div(Network_Ethereum_Core_BigNumber.euclidianRingBigNumber)(n)(Network_Ethereum_Core_BigNumber.pow(intToBigNumber(10))(dec - 2 | 0))) / 100.0);
      };
  };
  exports["SharedData"] = SharedData;
  exports["bigNumberToFloat"] = bigNumberToFloat;
  exports["bigNumberToInt"] = bigNumberToInt;
  exports["intToBigNumber"] = intToBigNumber;
  exports["intToWeiBigNumber"] = intToWeiBigNumber;
  exports["weiBigNumberToInt"] = weiBigNumberToInt;
  ...
  exports["weiBigNumberFiexed2"] = weiBigNumberFiexed2;
})(PS);
(function($PS) {
  "use strict";
  $PS["UI.Component.RelayableNFT.Table"] = $PS["UI.Component.RelayableNFT.Table"] || {};
  ...
  var NewTableEntrys = (function () {
      function NewTableEntrys(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      NewTableEntrys.create = function (value0) {
          return function (value1) {
              return new NewTableEntrys(value0, value1);
          };
      };
      return NewTableEntrys;
  })();
  var ClearTableEntry = (function () {
      function ClearTableEntry(value0) {
          this.value0 = value0;
      };
      ClearTableEntry.create = function (value0) {
          return new ClearTableEntry(value0);
      };
      return ClearTableEntry;
  })();
  ...
  var TableUpdateDecimals = (function () {
      function TableUpdateDecimals(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      TableUpdateDecimals.create = function (value0) {
          return function (value1) {
              return new TableUpdateDecimals(value0, value1);
          };
      };
      return TableUpdateDecimals;
  })();
      ...
      return function (dictMonadAsk) {
          var render = function (v) {
              var tableHeadings = (function () {
                  var balanceOfShow = UI_Component_RelayableNFT_Types.weiBigNumberToStringFiexed2(v.balanceOf)(v.decimals);
                  var totalShareShow = Data_Number_Format.toStringWith(Data_Number_Format.fixed(2))(UI_Component_RelayableNFT_Types.bigNumberToFloat(v.totalShare) / 100.0);
                  return [ "Index", "Address", (function () {
                      ...
                      if (v1.value0 instanceof Data_Maybe.Just && v1.value1 instanceof Data_Maybe.Just) {
                          var $21 = Data_Eq.eq(Network_Ethereum_Core_Signatures.addressEq)(v1.value0.value0)(v1.value1.value0);
                          if ($21) {
                              return "Volume (total: " + (totalShareShow + ")");
                          };
                          return "Volume ";
                      };
                      return "";
              ...
              var tableEntry = function (entry) {
                  ...
                  var td = td$prime("");
                  var shareVolumeShow = Data_Number_Format.toStringWith(Data_Number_Format.fixed(2))(UI_Component_RelayableNFT_Types.bigNumberToFloat(view.shareVolume) / 100.0);
                  var sharePercentageWith2fiexed = (function () {
                      var $28 = Data_Eq.notEq(Network_Ethereum_Core_BigNumber.eqBigNumber)(v.totalShare)(Data_Semiring.zero(Network_Ethereum_Core_BigNumber.semiringBigNumber));
                      if ($28) {
                  ...
                  var amountShow = UI_Component_RelayableNFT_Types.weiBigNumberToStringFiexed2(amount)(v.decimals);
                  var descriptionCell = [ td$prime("text-left")([ Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(view.index)) ]) ]), td$prime("text-left")([ Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text(Data_Show.show(Network_Ethereum_Core_Signatures.addressShow)(view.sharer)) ]) ]), (function () {
                      var v1 = new Data_Tuple.Tuple(v.adminAddress, v.userAddress);
                      if (v1.value0 instanceof Data_Maybe.Just && v1.value1 instanceof Data_Maybe.Just) {
                          var $31 = Data_Eq.eq(Network_Ethereum_Core_Signatures.addressEq)(v1.value0.value0)(v1.value1.value0);
                          if ($31) {
                              return td$prime("text-left")([ Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text(shareVolumeShow + (" (" + (sharePercentageShow + " %)"))) ]) ]);
                          };
                  ...
                  var v1 = new Data_Tuple.Tuple(v.adminAddress, v.userAddress);
                  if (v1.value0 instanceof Data_Maybe.Just && v1.value1 instanceof Data_Maybe.Just) {
                      var $39 = Data_Eq.eq(Network_Ethereum_Core_Signatures.addressEq)(v1.value0.value0)(v1.value1.value0) || Data_Eq.eq(Network_Ethereum_Core_Signatures.addressEq)(view.sharer)(v1.value1.value0);
                      if ($39) {
                          return Halogen_HTML_Elements.tr([ UI_Utils.css("line-height-event-log border-b border-dullergray border-opacity-75 last:border-b-0") ])(descriptionCell);
                      };
                      return Halogen_HTML_Elements.tr([ UI_Utils.css("") ])([  ]);
                  };
                  return Halogen_HTML_Elements.tr([ UI_Utils.css("") ])([ td$prime("text-left")([ Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text("wait connect wallet") ]) ]) ]);
              };
              ...
              var responsiveLink$prime = function (loose) {
                  return function (text) {
                      return function (href) {
                          ...
                          throw new Error("Failed pattern match at UI.Component.RelayableNFT.Table (line 170, column 43 - line 175, column 102): " + [ href.constructor.name ]);
                      };
                  };
              };
              ...
              var historicalEntriesInfo = (function () {
                  ...
                  var backfillCaveat = (function () {
                      if ($58.bfs instanceof BackfillFinished && ($58.noNew && $58.noOld)) {
                          return new Data_Maybe.Just("Not Have Sharer .");
                      };
                      if ($58.bfs instanceof BackfillRunning && ($58.noNew && $58.noOld)) {
                          return Data_Maybe.Just.create("No FOAM Lite events seen \u2013 searching chain history" + ellipsisOrBackfillPercentage($58.bfs.value0));
                      };
                      if ($58.bfs instanceof BackfillNeverStarted && ($58.noNew && $58.noOld)) {
                          return new Data_Maybe.Just("waiting to connect to Ethereum...");
                      };
                      if ($58.bfs instanceof BackfillErrored && ($58.noNew && $58.noOld)) {
                          return Data_Maybe.Just.create("No FOAM Lite events seen yet -- searching chain history failed: " + $58.bfs.value0);
                      };
                      if ($58.bfs instanceof BackfillRunning) {
                          return Data_Maybe.Just.create("Searching chain history for more FOAM Lite events" + ellipsisOrBackfillPercentage($58.bfs.value0));
                      };
                      if ($58.bfs instanceof BackfillErrored && $58.noOld) {
                  ...
                  throw new Error("Failed pattern match at UI.Component.RelayableNFT.Table (line 212, column 15 - line 214, column 38): " + [ backfillCaveat.constructor.name ]);
              })();
              var renderTableEntries = [ Halogen_HTML_Elements.tbody([ UI_Utils.css("body-half-screen") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(renderNewTableEntries)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(historicalEntriesInfo)(renderHistoricalTableEntries))) ];
              ...
              return Halogen_HTML_Elements.div([ UI_Utils.css("flex w-full px-4 ctable") ])([ Halogen_HTML_Elements.table([ UI_Utils.css("w-full ") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ tableHead ])(renderTableEntries)) ]);
          };
          var $$eval = (function () {
              var handleQuery = function (v) {
                  if (v instanceof NewTableEntrys) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $108.entries = v.value0;
                          return $108;
                      }))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(new Data_Maybe.Just(v.value1));
                      });
                  };
                  if (v instanceof ClearTableEntry) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          var $113 = {};
                          for (var $114 in st) {
                  ...
                  if (v instanceof BackfillExtentsDetermined) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $117.backfillExtents = new Data_Maybe.Just(v.value0);
                          return $117;
                      }))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(new Data_Maybe.Just(v.value1));
                      });
                  ...
                  if (v instanceof TableUpdateBalanceOf) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $137.balanceOf = v.value0;
                          return $137;
                      }))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(new Data_Maybe.Just(v.value1));
                      });
                  };
                  if (v instanceof TableUpdateDecimals) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          var $142 = {};
                          for (var $143 in v1) {
                          ...
                          $142.decimals = UI_Component_RelayableNFT_Types.bigNumberToInt(v.value0);
                          return $142;
                      }))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(new Data_Maybe.Just(v.value1));
                      });
                  ...
                  if (v instanceof TableUpdateUser) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $152.userAddress = new Data_Maybe.Just(v.value0);
                          return $152;
                      }))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(new Data_Maybe.Just(v.value1));
                      });
                  ...
                  if (v instanceof TableUpdateAdmin) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $157.adminAddress = new Data_Maybe.Just(v.value0);
                          return $157;
                      }))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(new Data_Maybe.Just(v.value1));
                      });
                  };
                  throw new Error("Failed pattern match at UI.Component.RelayableNFT.Table (line 272, column 23 - line 305, column 29): " + [ v.constructor.name ]);
              };
  ...
  exports["NewTableEntrys"] = NewTableEntrys;
  exports["ClearTableEntry"] = ClearTableEntry;
  ...
  exports["TableUpdateDecimals"] = TableUpdateDecimals;
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["UI.Component.RootType"] = $PS["UI.Component.RootType"] || {};
  var exports = $PS["UI.Component.RootType"];
  var Data_Eq = $PS["Data.Eq"];                
  ...
  var InputSaveAmount = (function () {
      function InputSaveAmount() {

      };
      InputSaveAmount.value = new InputSaveAmount();
      return InputSaveAmount;
  })();
  var InputSetSahreVolume = (function () {
      function InputSetSahreVolume() {

      };
      InputSetSahreVolume.value = new InputSetSahreVolume();
      return InputSetSahreVolume;
  })();
  var InputSetSahreAddress = (function () {
      function InputSetSahreAddress() {

      };
      InputSetSahreAddress.value = new InputSetSahreAddress();
      return InputSetSahreAddress;
  })();
  var InputSetNewSharer = (function () {
      function InputSetNewSharer() {

      };
      InputSetNewSharer.value = new InputSetNewSharer();
      return InputSetNewSharer;
  })();
  var InputSetNewAdmin = (function () {
      function InputSetNewAdmin() {

      };
      InputSetNewAdmin.value = new InputSetNewAdmin();
      return InputSetNewAdmin;
  })();
  var InputSetConfirm = (function () {
      function InputSetConfirm() {

      };
      InputSetConfirm.value = new InputSetConfirm();
      return InputSetConfirm;
  })();
  var InputSetWithdrawToken = (function () {
      function InputSetWithdrawToken() {

      };
      InputSetWithdrawToken.value = new InputSetWithdrawToken();
      return InputSetWithdrawToken;
  })();
  var InputRemoveVolume = (function () {
      function InputRemoveVolume() {

      };
      InputRemoveVolume.value = new InputRemoveVolume();
      return InputRemoveVolume;
  })();
  var InputRemoveAddress = (function () {
      function InputRemoveAddress() {

      };
      InputRemoveAddress.value = new InputRemoveAddress();
  ...
  var AddShareds = (function () {
      function AddShareds(value0) {
          this.value0 = value0;
      };
      AddShareds.create = function (value0) {
          return new AddShareds(value0);
      };
      return AddShareds;
  })();
  var Initialize = (function () {
  ...
  var UpdateDataFromBlockChain = (function () {
      function UpdateDataFromBlockChain() {

      };
      UpdateDataFromBlockChain.value = new UpdateDataFromBlockChain();
      return UpdateDataFromBlockChain;
  })();
  ...
  var DoUserInputAction = (function () {
      function DoUserInputAction(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      DoUserInputAction.create = function (value0) {
          return function (value1) {
              return new DoUserInputAction(value0, value1);
          };
      };
      return DoUserInputAction;
  })();
  var TableUpdateSetAmount = (function () {
  ...
  var TableUpdateDecimals = (function () {
      function TableUpdateDecimals(value0) {
          this.value0 = value0;
      };
      TableUpdateDecimals.create = function (value0) {
          return new TableUpdateDecimals(value0);
      };
      return TableUpdateDecimals;
  })();
  ...
  var Decimals = (function () {
      function Decimals(value0) {
          this.value0 = value0;
      };
      Decimals.create = function (value0) {
          return new Decimals(value0);
      };
      return Decimals;
  })();
  var PoolTx = (function () {
      function PoolTx(value0) {
          this.value0 = value0;
      };
      PoolTx.create = function (value0) {
          return new PoolTx(value0);
      };
      return PoolTx;
  })();
  ...
  exports["InputSaveAmount"] = InputSaveAmount;
  exports["InputSetSahreVolume"] = InputSetSahreVolume;
  exports["InputSetSahreAddress"] = InputSetSahreAddress;
  exports["InputSetNewSharer"] = InputSetNewSharer;
  exports["InputSetNewAdmin"] = InputSetNewAdmin;
  exports["InputSetConfirm"] = InputSetConfirm;
  exports["InputSetWithdrawToken"] = InputSetWithdrawToken;
  exports["InputRemoveVolume"] = InputRemoveVolume;
  exports["InputRemoveAddress"] = InputRemoveAddress;
  exports["Initialize"] = Initialize;
  exports["UpdateDataFromBlockChain"] = UpdateDataFromBlockChain;
  exports["NewAppEvent"] = NewAppEvent;
  exports["NFTBackfillStatusUpdate"] = NFTBackfillStatusUpdate;
  exports["SendToastMsg"] = SendToastMsg;
  exports["StartConnect"] = StartConnect;
  exports["Distribute"] = Distribute;
  exports["WithdrawToken"] = WithdrawToken;
  exports["BalanceOf"] = BalanceOf;
  exports["ContractAdmin"] = ContractAdmin;
  exports["DoUserInputAction"] = DoUserInputAction;
  exports["TableUpdateSetAmount"] = TableUpdateSetAmount;
  exports["TableUpdateBalanceOf"] = TableUpdateBalanceOf;
  exports["TableUpdateTotalShare"] = TableUpdateTotalShare;
  exports["TableUpdateDecimals"] = TableUpdateDecimals;
  exports["SetShareVolume"] = SetShareVolume;
  exports["SetNewAdmin"] = SetNewAdmin;
  exports["SetNewSharer"] = SetNewSharer;
  exports["SetRemoveSharer"] = SetRemoveSharer;
  exports["DoWeb3Action"] = DoWeb3Action;
  exports["HandleHeaderMessages"] = HandleHeaderMessages;
  exports["ChangePage"] = ChangePage;
  exports["Decimals"] = Decimals;
  exports["PoolTx"] = PoolTx;
  exports["Web3Distribute"] = Web3Distribute;
  exports["Web3SetShareVolume"] = Web3SetShareVolume;
  exports["Web3ChangeAdmin"] = Web3ChangeAdmin;
  exports["Web3RemoveSharer"] = Web3RemoveSharer;
  exports["Web3NewSharer"] = Web3NewSharer;
  exports["Web3Withdraw"] = Web3Withdraw;
  exports["AddShareds"] = AddShareds;
  exports["Action"] = Action;
  exports["Edit"] = Edit;
  exports["Contract"] = Contract;
  exports["eqSignature"] = eqSignature;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["UI.Component.RootWeb3"] = $PS["UI.Component.RootWeb3"] || {};
  var exports = $PS["UI.Component.RootWeb3"];
  ...
  var UI_Component_RelayableNFT_Types = $PS["UI.Component.RelayableNFT.Types"];
  var UI_Component_RootType = $PS["UI.Component.RootType"];                
  var pollTransactionReceipt = function (dictMonadAff) {
      return function (provider) {
          return function (txHash) {
              return function (k) {
                  return Effect_Aff_Class.liftAff(dictMonadAff)(Control_Bind.bind(Effect_Aff.bindAff)(Network_Ethereum_Web3_Types_Types.runWeb3(provider)(Network_Ethereum_Web3_Api.eth_getTransactionReceipt(txHash)))(function (eRes) {
                      if (eRes instanceof Data_Either.Left) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(2000.0))(function () {
                              return pollTransactionReceipt(Effect_Aff_Class.monadAffAff)(provider)(txHash)(k);
                          });
                      };
                      if (eRes instanceof Data_Either.Right) {
                          if (eRes.value0.status instanceof Network_Ethereum_Web3_Types_Types.Succeeded) {
                              return k(eRes.value0);
                          };
                          if (eRes.value0.status instanceof Network_Ethereum_Web3_Types_Types.Failed) {
                              return Partial_Unsafe.unsafeCrashWith("Transaction failed : " + Data_Show.show(Network_Ethereum_Core_HexString.showHexString)(txHash));
                          };
                          throw new Error("Failed pattern match at UI.Component.RootWeb3 (line 216, column 49 - line 218, column 75): " + [ eRes.value0.status.constructor.name ]);
                      };
                      throw new Error("Failed pattern match at UI.Component.RootWeb3 (line 212, column 5 - line 218, column 75): " + [ eRes.constructor.name ]);
                  }));
              };
          };
      };
  ...
  var mkWeb3MonitorBase = function (v) {
      return function (action) {
          return Effect_Aff.launchAff((function () {
              if (action instanceof UI_Component_RootType.Web3SetShareVolume) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)("send. " + (Data_Show.show(Network_Ethereum_Core_Signatures.addressShow)(action.value0) + (" " + (Data_Show.show(Network_Ethereum_Core_Signatures.addressShow)(action.value1) + (" " + Data_Show.show(Data_Show.showInt)(action.value2)))))))(function () {
                      ...
                      return Network_Ethereum_Web3_Types_Types.runWeb3(v.web3Provider)(Contracts_DistToken.setSharerVolume(txOpts)({
                          sharer: action.value1,
                          shareVolume: formatAmount
                      }));
                  });
              };
              if (action instanceof UI_Component_RootType.Web3NewSharer) {
                  var txOpts = DApp_Util.makeTx({
                      from: action.value0,
                      to: v.distToken
                  });
                  var formatAmount = UI_Component_RelayableNFT_Types["uIntNFromBigNumber'"](Network_Ethereum_Web3_Solidity_Size.knownSizeLoop(Network_Ethereum_Web3_Solidity_Size.countLoop(Network_Ethereum_Web3_Solidity_Size.countBase))(Network_Ethereum_Web3_Solidity_Size.knownSizeLoop(Network_Ethereum_Web3_Solidity_Size.countBase)(Network_Ethereum_Web3_Solidity_Size.knownSizeBase(Network_Ethereum_Web3_Solidity_Size.sizeN6))(Network_Ethereum_Web3_Solidity_Size.sizeN5))(Network_Ethereum_Web3_Solidity_Size.sizeN2))(Network_Ethereum_Web3_Solidity_Sizes.s256)(UI_Component_RelayableNFT_Types.intToBigNumber(0));
                  return Network_Ethereum_Web3_Types_Types.runWeb3(v.web3Provider)(Contracts_DistToken.addSharer(txOpts)({
                      sharer: action.value1,
                      initVolume: formatAmount
                  }));
              };
              if (action instanceof UI_Component_RootType.Web3ChangeAdmin) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)("send change Admin. " + Data_Show.show(Network_Ethereum_Core_Signatures.addressShow)(action.value1)))(function () {
                      ...
                      return Network_Ethereum_Web3_Types_Types.runWeb3(v.web3Provider)(Contracts_DistToken.changeAdmin(txOpts)({
                          "_newAdmin": action.value1,
                          "_key": action.value2
                      }));
                  });
              };
              if (action instanceof UI_Component_RootType.Web3RemoveSharer) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)("send remove sharer " + Data_Show.show(Network_Ethereum_Core_Signatures.addressShow)(action.value1)))(function () {
                      ...
                      var formatAmount = UI_Component_RelayableNFT_Types["uIntNFromBigNumber'"](Network_Ethereum_Web3_Solidity_Size.knownSizeLoop(Network_Ethereum_Web3_Solidity_Size.countLoop(Network_Ethereum_Web3_Solidity_Size.countBase))(Network_Ethereum_Web3_Solidity_Size.knownSizeLoop(Network_Ethereum_Web3_Solidity_Size.countBase)(Network_Ethereum_Web3_Solidity_Size.knownSizeBase(Network_Ethereum_Web3_Solidity_Size.sizeN6))(Network_Ethereum_Web3_Solidity_Size.sizeN5))(Network_Ethereum_Web3_Solidity_Size.sizeN2))(Network_Ethereum_Web3_Solidity_Sizes.s256)(UI_Component_RelayableNFT_Types.intToBigNumber(action.value2));
                      return Network_Ethereum_Web3_Types_Types.runWeb3(v.web3Provider)(Contracts_DistToken.removeAddress(txOpts)({
                          addr: action.value1,
                          check_volume: formatAmount
                      }));
                  });
              };
              if (action instanceof UI_Component_RootType.Web3Distribute) {
                  var txOpts = DApp_Util.makeTx({
                      from: action.value0,
                      to: v.distToken
                  });
                  var formatAmount = UI_Component_RelayableNFT_Types["uIntNFromBigNumber'"](Network_Ethereum_Web3_Solidity_Size.knownSizeLoop(Network_Ethereum_Web3_Solidity_Size.countLoop(Network_Ethereum_Web3_Solidity_Size.countBase))(Network_Ethereum_Web3_Solidity_Size.knownSizeLoop(Network_Ethereum_Web3_Solidity_Size.countBase)(Network_Ethereum_Web3_Solidity_Size.knownSizeBase(Network_Ethereum_Web3_Solidity_Size.sizeN6))(Network_Ethereum_Web3_Solidity_Size.sizeN5))(Network_Ethereum_Web3_Solidity_Size.sizeN2))(Network_Ethereum_Web3_Solidity_Sizes.s256)(action.value1);
                  return Network_Ethereum_Web3_Types_Types.runWeb3(v.web3Provider)(Contracts_DistToken.distShares(txOpts)({
                      costAmount: formatAmount
                  }));
              };
              if (action instanceof UI_Component_RootType.Web3Withdraw) {
                  var txOpts = DApp_Util.makeTx({
                      from: action.value0,
                      to: v.distToken
                  });
                  return Network_Ethereum_Web3_Types_Types.runWeb3(v.web3Provider)(Contracts_DistToken.withdraw(txOpts)({
                      token: action.value1
                  }));
              };
              throw new Error("Failed pattern match at UI.Component.RootWeb3 (line 87, column 5 - line 113, column 70): " + [ action.constructor.name ]);
          })());
      };
  };
  var mkWeb3Monitor = function (v) {
      var findContractDecimals = function (web3Provider1) {
          return function (txOpts) {
              return function (address) {
                  return Effect_Aff.launchAff(Control_Bind.bind(Effect_Aff.bindAff)(Network_Ethereum_Web3_Types_Types.runWeb3(web3Provider1)(Contracts_FungibleToken.decimals(txOpts)(Network_Ethereum_Web3_Types_Types.Latest.value)))(function (ePollResult) {
                      ...
                      if (ePollResult instanceof Data_Either.Right) {
                          return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)((function () {
                              ...
                              if (ePollResult.value0 instanceof Data_Either.Right) {
                                  return function __do() {
                                      Effect_Class_Console.log(Effect_Class.monadEffectEffect)("Find Decilmals" + Data_Show.show(Network_Ethereum_Core_Signatures.addressShow)(address))();
                                      Effect_Class.liftEffect(Effect_Class.monadEffectEffect)(Halogen_Query_EventSource.emit(v.emitter)(new UI_Component_RootType.Decimals(UI_Component_RelayableNFT_Types.bigNumberToInt(Network_Ethereum_Web3_Solidity_UInt.unUIntN(Network_Ethereum_Web3_Solidity_Size.knownSizeBase(Network_Ethereum_Web3_Solidity_Size.sizeN8))(ePollResult.value0.value0)))))();
                                      return Effect_Class.liftEffect(Effect_Class.monadEffectEffect)(Halogen_Query_EventSource.emit(v.emitter)(new UI_Component_RootType.TableUpdateDecimals(Network_Ethereum_Web3_Solidity_UInt.unUIntN(Network_Ethereum_Web3_Solidity_Size.knownSizeBase(Network_Ethereum_Web3_Solidity_Size.sizeN8))(ePollResult.value0.value0))))();
                                  };
                              };
                              throw new Error("Failed pattern match at UI.Component.RootWeb3 (line 167, column 11 - line 173, column 77): " + [ ePollResult.value0.constructor.name ]);
                          })());
                      };
                      throw new Error("Failed pattern match at UI.Component.RootWeb3 (line 163, column 7 - line 173, column 77): " + [ ePollResult.constructor.name ]);
                  }));
              };
          };
      };
                          ...
                          return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)((function () {
                              ...
                              if (ePollResult.value0 instanceof Data_Either.Right) {
                                  return function __do() {
                                      ...
                                      Effect_Class.liftEffect(Effect_Class.monadEffectEffect)(Halogen_Query_EventSource.emit(v.emitter)(new UI_Component_RootType.BalanceOf(Network_Ethereum_Web3_Solidity_UInt.unUIntN(Network_Ethereum_Web3_Solidity_Size.knownSizeLoop(Network_Ethereum_Web3_Solidity_Size.countLoop(Network_Ethereum_Web3_Solidity_Size.countBase))(Network_Ethereum_Web3_Solidity_Size.knownSizeLoop(Network_Ethereum_Web3_Solidity_Size.countBase)(Network_Ethereum_Web3_Solidity_Size.knownSizeBase(Network_Ethereum_Web3_Solidity_Size.sizeN6))(Network_Ethereum_Web3_Solidity_Size.sizeN5))(Network_Ethereum_Web3_Solidity_Size.sizeN2))(ePollResult.value0.value0))))();
                                      return Effect_Class.liftEffect(Effect_Class.monadEffectEffect)(Halogen_Query_EventSource.emit(v.emitter)(new UI_Component_RootType.TableUpdateBalanceOf(Network_Ethereum_Web3_Solidity_UInt.unUIntN(Network_Ethereum_Web3_Solidity_Size.knownSizeLoop(Network_Ethereum_Web3_Solidity_Size.countLoop(Network_Ethereum_Web3_Solidity_Size.countBase))(Network_Ethereum_Web3_Solidity_Size.knownSizeLoop(Network_Ethereum_Web3_Solidity_Size.countBase)(Network_Ethereum_Web3_Solidity_Size.knownSizeBase(Network_Ethereum_Web3_Solidity_Size.sizeN6))(Network_Ethereum_Web3_Solidity_Size.sizeN5))(Network_Ethereum_Web3_Solidity_Size.sizeN2))(ePollResult.value0.value0))))();
                                  };
                              };
                              throw new Error("Failed pattern match at UI.Component.RootWeb3 (line 154, column 11 - line 160, column 78): " + [ ePollResult.value0.constructor.name ]);
                          })());
                      };
                      throw new Error("Failed pattern match at UI.Component.RootWeb3 (line 150, column 7 - line 160, column 78): " + [ ePollResult.constructor.name ]);
                  }));
              };
          };
      };
                  ...
                  return Control_Bind.bind(Effect_Aff.bindAff)(Network_Ethereum_Web3_Types_Types.runWeb3(web3Provider1)(Contracts_DistToken.owner(txOpts)(Network_Ethereum_Web3_Types_Types.Latest.value)))(function (ePollResult) {
                      ...
                      if (ePollResult instanceof Data_Either.Right) {
                          return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)((function () {
                              ...
                              if (ePollResult.value0 instanceof Data_Either.Right) {
                                  return Effect_Class.liftEffect(Effect_Class.monadEffectEffect)(Halogen_Query_EventSource.emit(v.emitter)(new UI_Component_RootType.ContractAdmin(ePollResult.value0.value0)));
                              };
                              throw new Error("Failed pattern match at UI.Component.RootWeb3 (line 182, column 11 - line 186, column 64): " + [ ePollResult.value0.constructor.name ]);
                          })());
                      };
                      throw new Error("Failed pattern match at UI.Component.RootWeb3 (line 178, column 7 - line 186, column 64): " + [ ePollResult.constructor.name ]);
                  });
              }));
          };
      };
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)("Find address " + Data_Show.show(Network_Ethereum_Web3_Solidity_UInt.showUIntN)(n)))(function () {
                              ...
                              if (ePollResult instanceof Data_Either.Right) {
                                  return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)((function () {
                                      ...
                                      throw new Error("Failed pattern match at UI.Component.RootWeb3 (line 195, column 11 - line 200, column 48): " + [ ePollResult.value0.constructor.name ]);
                                  })());
                              };
                              throw new Error("Failed pattern match at UI.Component.RootWeb3 (line 191, column 7 - line 200, column 48): " + [ ePollResult.constructor.name ]);
                          });
                      }));
                  };
              };
          ...
          return Control_Bind.bind(Effect_Aff.bindAff)(Network_Ethereum_Web3_Types_Types.runWeb3(v.web3Provider)(Contracts_DistToken.getShareVolumeMap(txOpts)(Network_Ethereum_Web3_Types_Types.Latest.value)))(function (ePollResult) {
              ...
              if (ePollResult instanceof Data_Either.Right && ePollResult.value0 instanceof Data_Either.Right) {
                  return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)((function () {
                      ...
                      var fullShareListWithIndex = Data_Array.reverse(Data_Array.mapWithIndex(function (i) {
                          return function (v1) {
                              return new Network_Ethereum_Web3_Solidity_Tuple.Tuple3(i, v1.value0, v1.value1);
                          };
                      })(fullShareList));
                      return function __do() {
                          Effect_Class.liftEffect(Effect_Class.monadEffectEffect)(Halogen_Query_EventSource.emit(v.emitter)((function (xs1) {
                              return new UI_Component_RootType.NewAppEvent({
                                  event: new UI_Component_RootType.AddShareds(xs1)
                              });
                          })(Data_Array.reverse(Data_Functor.map(Data_Functor.functorArray)(function (v1) {
                              return new UI_Component_RelayableNFT_Types.SharedData({
                                  index: v1.value0 + 1 | 0,
                                  sharerAddress: v1.value1,
                          ...
                          })(fullShareListWithIndex)))))();
                          Effect_Class.liftEffect(Effect_Class.monadEffectEffect)(Halogen_Query_EventSource.emit(v.emitter)(new UI_Component_RootType.TableUpdateTotalShare(totalShare)))();
                          ...
                          Effect_Class.liftEffect(Effect_Class.monadEffectEffect)(Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableArray)(findContractDecimals(v.web3Provider)(DApp_Util.makeTxOpts({
                              from: Network_Ethereum_Core_Signatures.nullAddress,
                              to: v.ercTokenAddress
                          })))([ v.distToken ]))();
                          return Effect_Class.liftEffect(Effect_Class.monadEffectEffect)(Halogen_Query_EventSource.emit(v.emitter)(new UI_Component_RootType.NFTBackfillStatusUpdate(UI_Component_RelayableNFT_Table.BackfillFinished.value)))();
                      };
                  })());
              };
              throw new Error("Failed pattern match at UI.Component.RootWeb3 (line 120, column 5 - line 145, column 88): " + [ ePollResult.constructor.name ]);
          });
      })());
  };
  exports["mkWeb3MonitorBase"] = mkWeb3MonitorBase;
  exports["mkWeb3Monitor"] = mkWeb3Monitor;
  exports["pollTransactionReceipt"] = pollTransactionReceipt;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["UI.Component.RootAction"] = $PS["UI.Component.RootAction"] || {};
  var exports = $PS["UI.Component.RootAction"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Lazy = $PS["Control.Lazy"];
  var Control_Monad_Reader_Class = $PS["Control.Monad.Reader.Class"];
  ...
  var UI_Component_RelayableNFT_Types = $PS["UI.Component.RelayableNFT.Types"];
  var UI_Component_RootType = $PS["UI.Component.RootType"];
  var UI_Component_RootWeb3 = $PS["UI.Component.RootWeb3"];
  var UI_Config = $PS["UI.Config"];
  var Web_HTML = $PS["Web.HTML"];                
  var handleUserInputAction = function (dictMonadAff) {
      return function (dictMonadAsk) {
          return function (uia) {
              return function (a) {
                  if (uia instanceof UI_Component_RootType.InputSetWithdrawToken) {
                      var v = Data_Functor.map(Data_Maybe.functorMaybe)(Network_Ethereum_Core_Signatures.mkAddress)(Network_Ethereum_Core_HexString.mkHexString(a));
                      if (v instanceof Data_Maybe.Just && v.value0 instanceof Data_Maybe.Just) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("InputSetNewSharer  OK : " + Data_Show.show(Network_Ethereum_Core_Signatures.addressShow)(v.value0.value0)))(function () {
                              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                                  ...
                                  $75.withdrawToken = new Data_Maybe.Just(v.value0.value0);
                                  return $75;
                              });
                          });
                      };
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("InputSetNewSharer fail : " + Data_Show.show(Data_Show.showString)(a)))(function () {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                              var $80 = {};
                              for (var $81 in v1) {
                              ...
                              $80.withdrawToken = Data_Maybe.Nothing.value;
                              return $80;
                          });
                      });
                  };
                  if (uia instanceof UI_Component_RootType.InputSetNewSharer) {
                      var v = Data_Functor.map(Data_Maybe.functorMaybe)(Network_Ethereum_Core_Signatures.mkAddress)(Network_Ethereum_Core_HexString.mkHexString(a));
                      if (v instanceof Data_Maybe.Just && v.value0 instanceof Data_Maybe.Just) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("InputSetNewSharer  OK : " + Data_Show.show(Network_Ethereum_Core_Signatures.addressShow)(v.value0.value0)))(function () {
                              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                                  ...
                                  $84.setNewSharer = new Data_Maybe.Just(v.value0.value0);
                                  return $84;
                              });
                          });
                      };
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("InputSetNewSharer fail : " + Data_Show.show(Data_Show.showString)(a)))(function () {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                              ...
                              $89.setNewSharer = Data_Maybe.Nothing.value;
                              return $89;
                          });
                      });
                  };
                  if (uia instanceof UI_Component_RootType.InputRemoveVolume) {
                      var v = Data_Float_Parse["parseFloat"](a);
                      if (v instanceof Data_Maybe.Just) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("InputRemoveVolume  OK : " + Data_Show.show(Data_Show.showNumber)(v.value0)))(function () {
                              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                                  var $93 = {};
                                  for (var $94 in v1) {
                                  ...
                                  $93.setRemoveVolume = new Data_Maybe.Just(v.value0);
                                  return $93;
                              });
                          });
                      };
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("InputRemoveVolume fail : " + Data_Show.show(Data_Show.showString)(a)))(function () {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                              var $97 = {};
                              for (var $98 in v1) {
                              ...
                              $97.setRemoveVolume = Data_Maybe.Nothing.value;
                              return $97;
                          });
                      });
                  };
                  if (uia instanceof UI_Component_RootType.InputRemoveAddress) {
                      var v = Data_Functor.map(Data_Maybe.functorMaybe)(Network_Ethereum_Core_Signatures.mkAddress)(Network_Ethereum_Core_HexString.mkHexString(a));
                      if (v instanceof Data_Maybe.Just && v.value0 instanceof Data_Maybe.Just) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("InputRemoveAddress  OK : " + Data_Show.show(Network_Ethereum_Core_Signatures.addressShow)(v.value0.value0)))(function () {
                              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                                  var $101 = {};
                                  for (var $102 in v1) {
                                  ...
                                  $101.setRemoveAddress = new Data_Maybe.Just(v.value0.value0);
                                  return $101;
                              });
                          });
                      };
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("InputRemoveAddress fail : " + Data_Show.show(Data_Show.showString)(a)))(function () {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                              var $106 = {};
                              for (var $107 in v1) {
                              ...
                              $106.setRemoveAddress = Data_Maybe.Nothing.value;
                              return $106;
                          });
                      });
                  };
                  if (uia instanceof UI_Component_RootType.InputSetNewAdmin) {
                      var v = Data_Functor.map(Data_Maybe.functorMaybe)(Network_Ethereum_Core_Signatures.mkAddress)(Network_Ethereum_Core_HexString.mkHexString(a));
                      if (v instanceof Data_Maybe.Just && v.value0 instanceof Data_Maybe.Just) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("InputSetNewAdmin  OK : " + Data_Show.show(Network_Ethereum_Core_Signatures.addressShow)(v.value0.value0)))(function () {
                              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                                  var $110 = {};
                                  for (var $111 in v1) {
                                  ...
                                  $110.setNewAdmin = new Data_Maybe.Just(v.value0.value0);
                                  return $110;
                              });
                          });
                      };
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("InputSetNewAdmin fail : " + Data_Show.show(Data_Show.showString)(a)))(function () {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                              var $115 = {};
                              for (var $116 in v1) {
                              ...
                              $115.setNewAdmin = Data_Maybe.Nothing.value;
                              return $115;
                          });
                      });
                  };
                  if (uia instanceof UI_Component_RootType.InputSaveAmount) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
                          ...
                          var allIsInt = Data_Foldable.all(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(Data_Char_Unicode.isDigit)(Data_String_CodeUnits.toCharArray(a));
                          var v = new Data_Tuple.Tuple(allIsInt, Data_Functor.map(Data_Maybe.functorMaybe)(function (n) {
                              return Data_Functor.map(Data_Maybe.functorMaybe)(function (r) {
                                  return Network_Ethereum_Core_BigNumber.parseBigNumber(r)(Data_Show.show(Network_Ethereum_Core_BigNumber.showBigNumber)(UI_Component_RelayableNFT_Types.intToWeiBigNumber(n)(decimals)));
                              })(Data_Int.radix(10));
                          })(Data_Int_Parse["parseInt"](a)(Data_Int_Parse.toRadix(10))));
                          if (v.value0 && (v.value1 instanceof Data_Maybe.Just && (v.value1.value0 instanceof Data_Maybe.Just && v.value1.value0.value0 instanceof Data_Maybe.Just))) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("InputSaveAmount OK : " + Data_Show.show(Network_Ethereum_Core_BigNumber.showBigNumber)(v.value1.value0.value0.value0)))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                                      var $119 = {};
                                      for (var $120 in v1) {
                                      ...
                                      $119.saveAmount = new Data_Maybe.Just(v.value1.value0.value0.value0);
                                      return $119;
                                  }))(function () {
                                      return handleAction(dictMonadAff)(dictMonadAsk)(new UI_Component_RootType.TableUpdateSetAmount(v.value1.value0.value0.value0));
                                  });
                              });
                          };
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("InputSaveAmount fail : " + Data_Show.show(Data_Show.showString)(a)))(function () {
                              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                                  var $127 = {};
                                  for (var $128 in v1) {
                                  ...
                                  $127.saveAmount = Data_Maybe.Nothing.value;
                                  return $127;
                              });
                          });
                      });
                  };
                  if (uia instanceof UI_Component_RootType.InputSetSahreAddress) {
                      var v = Data_Functor.map(Data_Maybe.functorMaybe)(Network_Ethereum_Core_Signatures.mkAddress)(Network_Ethereum_Core_HexString.mkHexString(a));
                      if (v instanceof Data_Maybe.Just && v.value0 instanceof Data_Maybe.Just) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("InputSetSahreAddress  1 OK : " + Data_Show.show(Network_Ethereum_Core_Signatures.addressShow)(v.value0.value0)))(function () {
                              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                                  var $131 = {};
                                  for (var $132 in v1) {
                                  ...
                                  $131.setSharerAddress = new Data_Maybe.Just(v.value0.value0);
                                  return $131;
                              });
                          });
                      };
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("InputSetSahreAddress fail : " + Data_Show.show(Data_Show.showString)(a)))(function () {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                              var $136 = {};
                              for (var $137 in v1) {
                              ...
                              $136.setSharerAddress = Data_Maybe.Nothing.value;
                              return $136;
                          });
                      });
                  };
                  if (uia instanceof UI_Component_RootType.InputSetSahreVolume) {
                      var v = Data_Float_Parse["parseFloat"](a);
                      if (v instanceof Data_Maybe.Just) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("InputSetSahreVolume  OK : " + Data_Show.show(Data_Show.showNumber)(v.value0)))(function () {
                              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                                  var $140 = {};
                                  for (var $141 in v1) {
                                  ...
                                  $140.setSharerVolume = new Data_Maybe.Just(v.value0);
                                  return $140;
                              });
                          });
                      };
                      if (v instanceof Data_Maybe.Nothing) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("InputSetSahreVolume fail : " + Data_Show.show(Data_Show.showString)(a)))(function () {
                              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                                  var $144 = {};
                                  for (var $145 in v1) {
                                  ...
                                  $144.setSharerVolume = Data_Maybe.Nothing.value;
                                  return $144;
                              });
                          });
                      };
                      throw new Error("Failed pattern match at UI.Component.RootAction (line 160, column 9 - line 166, column 58): " + [ v.constructor.name ]);
                  };
                  if (uia instanceof UI_Component_RootType.InputSetConfirm) {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
                          ...
                          $147.confirm = new Data_Maybe.Just(a);
                          return $147;
                      });
                  };
                  throw new Error("Failed pattern match at UI.Component.RootAction (line 99, column 4 - line 168, column 47): " + [ uia.constructor.name ]);
              };
          };
      };
  };
  var handleAction = function (dictMonadAff) {
      return function (dictMonadAsk) {
          return function (v) {
              if (v instanceof UI_Component_RootType.PoolTx) {
                  if (v.value0 instanceof Data_Maybe.Just) {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $152.waitTx = new Data_Maybe.Just(v.value0.value0);
                          $152.lastTx = new Data_Maybe.Just(v.value0.value0);
                          return $152;
                      });
                  };
                  if (v.value0 instanceof Data_Maybe.Nothing) {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $156.waitTx = Data_Maybe.Nothing.value;
                          return $156;
                      });
                  };
                  throw new Error("Failed pattern match at UI.Component.RootAction (line 173, column 18 - line 177, column 67): " + [ v.value0.constructor.name ]);
              };
              if (v instanceof UI_Component_RootType.ChangePage) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      var $160 = {};
                      for (var $161 in v1) {
                      ...
                      $160.currentOptionPage = v.value0;
                      return $160;
                  });
              };
              if (v instanceof UI_Component_RootType.DoUserInputAction) {
                  return handleUserInputAction(dictMonadAff)(dictMonadAsk)(v.value0)(v.value1);
              };
              if (v instanceof UI_Component_RootType.DoWeb3Action) {
                              ...
                              if (eNetProps instanceof Data_Either.Right) {
                                  ...
                                  if (v2 instanceof Data_Maybe.Nothing) {
                                      ...
                                      var toastableNetworksStr = (function () {
                                          var $171 = Data_Array["null"](toastableNetworks);
                                          if ($171) {
                                  ...
                                  if (v2 instanceof Data_Maybe.Just) {
                                      ...
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                          ...
                                          throw new Error("Failed pattern match at UI.Component.RootAction (line 212, column 28 - line 214, column 144): " + [ netMeta.constructor.name ]);
                                      })())(function () {
                                          var toastReadyNetworkName = (function () {
                                              ...
                                              throw new Error("Failed pattern match at UI.Component.RootAction (line 216, column 56 - line 218, column 71): " + [ netMeta.constructor.name ]);
                                          })();
                                          return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.subscribe(Halogen_Query_EventSource.effectEventSource(dictMonadAff)(function (emitter) {
                                              return function __do() {
                                                  var fiber = UI_Component_RootWeb3.mkWeb3MonitorBase({
                                                      emitter: emitter,
                                                      distToken: v2.value0.address,
                                                      ercTokenAddress: v2.value0.ercTokenAddress,
                                                      web3Provider: v1.maybeWeb3Provider.value0
                                                  })(v.value0)();
                                                  Effect_Aff.launchAff_(Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff.joinFiber(fiber))(function (r) {
                                                      if (r instanceof Data_Either.Right) {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Halogen_Query_EventSource.emit(emitter)(UI_Component_RootType.PoolTx.create(new Data_Maybe.Just(r.value0)))))(function () {
                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Class_Console.log(Effect_Class.monadEffectEffect)("send. " + Data_Show.show(Network_Ethereum_Core_HexString.showHexString)(r.value0))))(function () {
                                                                  return Control_Bind.bind(Effect_Aff.bindAff)(UI_Component_RootWeb3.pollTransactionReceipt(Effect_Aff_Class.monadAffAff)(v1.maybeWeb3Provider.value0)(r.value0)(Control_Applicative.pure(Effect_Aff.applicativeAff)))(function (v3) {
                                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Class_Console.log(Effect_Class.monadEffectEffect)("send. " + Data_Show.show(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                                                                          return "blockHash";
                                                                      }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                                                                          return "blockNumber";
                                                                      }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                                                                          ...
                                                                          return "transactionIndex";
                                                                      }))(Data_Show.showRecordFieldsNil)(Network_Ethereum_Core_BigNumber.showBigNumber))(Network_Ethereum_Core_HexString.showHexString))(Network_Ethereum_Web3_Types_Types.showTransactionStatus))(Data_Show.showArray(Network_Ethereum_Web3_Types_Types.showChange)))(Network_Ethereum_Core_BigNumber.showBigNumber))(Network_Ethereum_Core_BigNumber.showBigNumber))(Data_Maybe.showMaybe(Network_Ethereum_Core_Signatures.addressShow)))(Network_Ethereum_Web3_Types_Types.showBlockNumber))(Network_Ethereum_Core_HexString.showHexString)))(v3))))(function () {
                                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Halogen_Query_EventSource.emit(emitter)(UI_Component_RootType.UpdateDataFromBlockChain.value)))(function () {
                                                                              return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Halogen_Query_EventSource.emit(emitter)(new UI_Component_RootType.PoolTx(Data_Maybe.Nothing.value)));
                                                                          });
                                                                      });
                                                                  });
                                                              });
                                                      ...
                                                      if (r instanceof Data_Either.Left) {
                                                          return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Class_Console.log(Effect_Class.monadEffectEffect)("send. " + Data_Show.show(Network_Ethereum_Web3_Types_Types.showWeb3Error)(r.value0)));
                                                      };
                                                      throw new Error("Failed pattern match at UI.Component.RootAction (line 230, column 34 - line 239, column 87): " + [ r.constructor.name ]);
                                                  }))();
                                                  return Halogen_Query_EventSource.Finalizer(Effect_Aff.launchAff_(Effect_Aff.killFiber(Effect_Exception.error("Component teardown"))(fiber)));
                                              };
                                          })));
                                      });
                                  };
                                  throw new Error("Failed pattern match at UI.Component.RootAction (line 196, column 24 - line 244, column 81): " + [ v2.constructor.name ]);
                              };
                              throw new Error("Failed pattern match at UI.Component.RootAction (line 193, column 19 - line 244, column 81): " + [ eNetProps.constructor.name ]);
                          });
                      };
                      throw new Error("Failed pattern match at UI.Component.RootAction (line 185, column 10 - line 244, column 81): " + [ v1.maybeWeb3Provider.constructor.name ]);
                  });
              };
              if (v instanceof UI_Component_RootType.SetShareVolume) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at UI.Component.RootAction (line 248, column 27 - line 250, column 78): " + [ v1.constructor.name ]);
                  })())(function (baseAddressGo) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          return v1.setSharerAddress;
                      }))(function (address) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                              return v1.setSharerVolume;
                          }))(function (rate) {
                              ...
                              if (address instanceof Data_Maybe.Just) {
                                  if (rate instanceof Data_Maybe.Nothing) {
                                      return Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("Do Set fail r: " + Data_Show.show(Data_Maybe.showMaybe(Data_Show.showNumber))(rate));
                                  };
                                  if (rate instanceof Data_Maybe.Just) {
                                      var fixed2Amount = Data_Int.ceil(rate.value0 * 100.0);
                                      return handleAction(dictMonadAff)(dictMonadAsk)(new UI_Component_RootType.DoWeb3Action(new UI_Component_RootType.Web3SetShareVolume(baseAddressGo, address.value0, fixed2Amount)));
                                  };
                                  throw new Error("Failed pattern match at UI.Component.RootAction (line 256, column 16 - line 260, column 102): " + [ rate.constructor.name ]);
                              };
                              throw new Error("Failed pattern match at UI.Component.RootAction (line 253, column 10 - line 260, column 102): " + [ address.constructor.name ]);
                          });
                      });
                  });
              };
              if (v instanceof UI_Component_RootType.SetNewAdmin) {
                  var a = Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Network_Ethereum_Core_HexString.mkHexString)(UI_Config.getAddress(Data_Maybe.Nothing.value)(Data_Maybe.Just.create));
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      var v1 = Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Network_Ethereum_Core_Signatures.mkAddress)(a);
                      if (v1 instanceof Data_Maybe.Just) {
                      ...
                      throw new Error("Failed pattern match at UI.Component.RootAction (line 263, column 27 - line 265, column 78): " + [ v1.constructor.name ]);
                  })())(function (baseAddressGo) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                              ...
                              if (v1.value0 instanceof Data_Maybe.Just && v1.value1 instanceof Data_Maybe.Just) {
                                  return handleAction(dictMonadAff)(dictMonadAsk)(new UI_Component_RootType.DoWeb3Action(new UI_Component_RootType.Web3ChangeAdmin(baseAddressGo, v1.value0.value0, v1.value1.value0)));
                              };
              ...
              if (v instanceof UI_Component_RootType.SetRemoveSharer) {
                  var a = Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Network_Ethereum_Core_HexString.mkHexString)(UI_Config.getAddress(Data_Maybe.Nothing.value)(Data_Maybe.Just.create));
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      var v1 = Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Network_Ethereum_Core_Signatures.mkAddress)(a);
                      if (v1 instanceof Data_Maybe.Just) {
                      ...
                      throw new Error("Failed pattern match at UI.Component.RootAction (line 273, column 27 - line 275, column 78): " + [ v1.constructor.name ]);
                  })())(function (baseAddressGo) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                              ...
                              if (v1.value0 instanceof Data_Maybe.Just && v1.value1 instanceof Data_Maybe.Just) {
                                  var fixed2Amount = Data_Int.ceil(v1.value1.value0 * 100.0);
                                  return handleAction(dictMonadAff)(dictMonadAsk)(new UI_Component_RootType.DoWeb3Action(new UI_Component_RootType.Web3RemoveSharer(baseAddressGo, v1.value0.value0, fixed2Amount)));
                              };
                              return Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("Do Set fail a: " + Data_Show.show(Data_Maybe.showMaybe(Network_Ethereum_Core_Signatures.addressShow))(address));
                          });
                      });
              ...
              if (v instanceof UI_Component_RootType.SetNewSharer) {
                  var a = Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Network_Ethereum_Core_HexString.mkHexString)(UI_Config.getAddress(Data_Maybe.Nothing.value)(Data_Maybe.Just.create));
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      var v1 = Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Network_Ethereum_Core_Signatures.mkAddress)(a);
                      if (v1 instanceof Data_Maybe.Just) {
                      ...
                      throw new Error("Failed pattern match at UI.Component.RootAction (line 285, column 27 - line 287, column 78): " + [ v1.constructor.name ]);
                  })())(function (baseAddressGo) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          if (address instanceof Data_Maybe.Just) {
                              return handleAction(dictMonadAff)(dictMonadAsk)(new UI_Component_RootType.DoWeb3Action(new UI_Component_RootType.Web3NewSharer(baseAddressGo, address.value0)));
                          };
                          throw new Error("Failed pattern match at UI.Component.RootAction (line 289, column 10 - line 291, column 89): " + [ address.constructor.name ]);
                      });
                  });
              };
              if (v instanceof UI_Component_RootType.WithdrawToken) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          if (v1.value0 instanceof Data_Maybe.Just && v1.value1 instanceof Data_Maybe.Just) {
                              return handleAction(dictMonadAff)(dictMonadAsk)(new UI_Component_RootType.DoWeb3Action(new UI_Component_RootType.Web3Withdraw(v1.value1.value0, v1.value0.value0)));
                          };
              ...
              if (v instanceof UI_Component_RootType.Distribute) {
                  var a = Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Network_Ethereum_Core_HexString.mkHexString)(UI_Config.getAddress(Data_Maybe.Nothing.value)(Data_Maybe.Just.create));
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      var v1 = Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Network_Ethereum_Core_Signatures.mkAddress)(a);
                      if (v1 instanceof Data_Maybe.Just) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          if (amount instanceof Data_Maybe.Just) {
                              return handleAction(dictMonadAff)(dictMonadAsk)(new UI_Component_RootType.DoWeb3Action(new UI_Component_RootType.Web3Distribute(baseAddressGo, amount.value0)));
                          };
                          throw new Error("Failed pattern match at UI.Component.RootAction (line 305, column 10 - line 308, column 84): " + [ amount.constructor.name ]);
                      });
                  });
              };
              if (v instanceof UI_Component_RootType.BalanceOf) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      return v1.decimals;
                  }))(function (decimals) {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $223.balanceOf = Data_Maybe.Just.create(UI_Component_RelayableNFT_Types.weiBigNumberFiexed2(v.value0)(decimals));
                          return $223;
                      });
                  });
              };
              if (v instanceof UI_Component_RootType.Decimals) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      var $227 = {};
                      for (var $228 in v1) {
                      ...
                      $227.decimals = v.value0;
                      return $227;
                  });
              };
              if (v instanceof UI_Component_RootType.ContractAdmin) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      var $231 = {};
                      for (var $232 in v1) {
                      ...
                      $231.contractAdmin = new Data_Maybe.Just(v.value0);
                      return $231;
                  }))(function () {
                      return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
                          return "nftTable";
              ...
              if (v instanceof UI_Component_RootType.UpdateDataFromBlockChain) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("UpdateDataFromBlockChain"))(function () {
                      var sendToast = function (m) {
                          return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
                              return "toast";
                          }))(Data_Ord.ordUnit)(UI_Component_Logging_Toast["_toast"])(Data_Unit.unit)(Halogen_Query.tell(UI_Component_Logging_Toast.DisplayMsg.create(m))));
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Reader_Class.ask(Halogen_Query_HalogenM.monadAskHalogenM(dictMonadAsk)))(function (v1) {
                          ...
                          if (v1.maybeWeb3Provider instanceof Data_Maybe.Just) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                  return v2.contractAddress;
                              }))(function (distTokenM) {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                      return v2.ercAddress;
                                  }))(function (ercTokenAddressM) {
                                      var v2 = new Data_Tuple.Tuple(distTokenM, ercTokenAddressM);
                                      if (v2.value0 instanceof Data_Maybe.Just && v2.value1 instanceof Data_Maybe.Just) {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
                                              return "nftTable";
                                          }))(Data_Ord.ordUnit)(UI_Component_RelayableNFT_Table["_nftTable"])(Data_Unit.unit)(Halogen_Query.tell(UI_Component_RelayableNFT_Table.ClearTableEntry.create))))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.subscribe(Halogen_Query_EventSource.effectEventSource(dictMonadAff)(function (emitter) {
                                                  return function __do() {
                                                      var historyFiber = UI_Component_RootWeb3.mkWeb3Monitor({
                                                          emitter: emitter,
                                                          distToken: v2.value0.value0,
                                                          ercTokenAddress: v2.value1.value0,
                                                          web3Provider: v1.maybeWeb3Provider.value0
                                                      })();
                                                  ...
                                                  return sendToast({
                                                      "_type": UI_Component_Logging_Toast.Info.value,
                                                      message: "Update Complete."
                                                  });
                                              });
                                          });
                                      };
                                      return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Class_Console.log(Effect_Class.monadEffectEffect)("App Not Readly."));
                                  });
                              });
                          };
                          throw new Error("Failed pattern match at UI.Component.RootAction (line 323, column 7 - line 342, column 63): " + [ v1.maybeWeb3Provider.constructor.name ]);
                      });
                  });
              };
              if (v instanceof UI_Component_RootType.Initialize) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Class_Console.log(Effect_Class.monadEffectEffect)("Root init")))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Effect_Aff_Bus.make(Effect_Aff.monadEffectAff)))(function (messages) {
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $247.busR = new Data_Maybe.Just(v1.value0);
                              $247.busW = new Data_Maybe.Just(v1.value1);
                              return $247;
                          }))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
                                  return "header";
                                              ...
                                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Network_Ethereum_Web3_Types_Types.runWeb3(v2.maybeWeb3Provider.value0)(Control_Bind.bind(Network_Ethereum_Web3_Types_Types.bindWeb3)(Network_Ethereum_Web3_Api.eth_blockNumber)(function (chainHeadBlockNumber) {
                                                  ...
                                                  if (eNetProps instanceof Data_Either.Right) {
                                                      ...
                                                      if (v3 instanceof Data_Maybe.Nothing) {
                                                          ...
                                                          var toastableNetworksStr = (function () {
                                                              var $255 = Data_Array["null"](toastableNetworks);
                                                              if ($255) {
                                                                  return "<looks like I was built without any artifact deployments... whoops...>";
                                                              };
                                                      ...
                                                      throw new Error("Failed pattern match at UI.Component.RootAction (line 364, column 71 - line 412, column 82): " + [ v3.constructor.name ]);
                                                  };
                                                  throw new Error("Failed pattern match at UI.Component.RootAction (line 362, column 13 - line 412, column 82): " + [ eNetProps.constructor.name ]);
                                              });
                                          };
                                          throw new Error("Failed pattern match at UI.Component.RootAction (line 353, column 7 - line 412, column 82): " + [ v2.maybeWeb3Provider.constructor.name ]);
                                      });
                                  });
                              });
                          });
              ...
              if (v instanceof UI_Component_RootType.StartConnect) {
                  return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
                      return "header";
              ...
              if (v instanceof UI_Component_RootType.SendToastMsg) {
                  return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
                      return "toast";
              ...
              if (v instanceof UI_Component_RootType.NFTBackfillStatusUpdate) {
                  return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
                      return "nftTable";
              ...
              if (v instanceof UI_Component_RootType.NewAppEvent) {
                  return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
                      return "nftTable";
                  }))(Data_Ord.ordUnit)(UI_Component_RelayableNFT_Table["_nftTable"])(Data_Unit.unit)(Halogen_Query.tell(UI_Component_RelayableNFT_Table.NewTableEntrys.create(v.value0.event.value0))));
              };
              if (v instanceof UI_Component_RootType.TableUpdateTotalShare) {
              ...
              if (v instanceof UI_Component_RootType.TableUpdateBalanceOf) {
              ...
              if (v instanceof UI_Component_RootType.TableUpdateDecimals) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Class_Console.log(Effect_Class.monadEffectEffect)("TableUpdateDecimals: " + Data_Show.show(Network_Ethereum_Core_BigNumber.showBigNumber)(v.value0))))(function () {
                      return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
                          return "nftTable";
                      }))(Data_Ord.ordUnit)(UI_Component_RelayableNFT_Table["_nftTable"])(Data_Unit.unit)(Halogen_Query.tell(UI_Component_RelayableNFT_Table.TableUpdateDecimals.create(v.value0))));
                  });
              };
              if (v instanceof UI_Component_RootType.TableUpdateSetAmount) {
              ...
              if (v instanceof UI_Component_RootType.HandleHeaderMessages) {
                  if (v.value0 instanceof UI_Component_Header_Component.OnConnected) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          var $289 = {};
                          for (var $290 in v1) {
                          ...
                          $289.web3Address = new Data_Maybe.Just(v.value0.value0);
                          return $289;
                      }))(function () {
                          return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
                              return "nftTable";
                  ...
                  if (v.value0 instanceof UI_Component_Header_Component.Refresh) {
                      return Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("send. ");
                  };
                  throw new Error("Failed pattern match at UI.Component.RootAction (line 440, column 7 - line 445, column 35): " + [ v.value0.constructor.name ]);
              };
              throw new Error("Failed pattern match at UI.Component.RootAction (line 172, column 16 - line 445, column 35): " + [ v.constructor.name ]);
          };
      };
  };
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["UI.Component.RootState"] = $PS["UI.Component.RootState"] || {};
  var exports = $PS["UI.Component.RootState"];
  var Data_Maybe = $PS["Data.Maybe"];
  var UI_Component_RootType = $PS["UI.Component.RootType"];                
  var initialState = {
      saveAmount: Data_Maybe.Nothing.value,
      setSharerAddress: Data_Maybe.Nothing.value,
      setSharerVolume: Data_Maybe.Nothing.value,
      ...
      currentOptionPage: UI_Component_RootType.Action.value,
      contractAddress: Data_Maybe.Nothing.value,
      ercAddress: Data_Maybe.Nothing.value,
      decimals: 0,
      waitTx: Data_Maybe.Nothing.value,
      lastTx: Data_Maybe.Nothing.value
  };
...
(function($PS) {
  ...
  var UI_Component_RelayableNFT_Table = $PS["UI.Component.RelayableNFT.Table"];
  var UI_Component_RelayableNFT_Types = $PS["UI.Component.RelayableNFT.Types"];
  var UI_Component_RootAction = $PS["UI.Component.RootAction"];
  var UI_Component_RootState = $PS["UI.Component.RootState"];
  var UI_Component_RootType = $PS["UI.Component.RootType"];
  var UI_Utils = $PS["UI.Utils"];
  ...
  var component = function (dictMonadAff) {
      return function (dictMonadAsk) {
          var render = function (s) {
              var toggle = function (currentType) {
                  return function (isType) {
                      var $12 = Data_Eq.eq(UI_Component_RootType.eqSignature)(currentType)(isType);
                      if ($12) {
                          return " py-2 h-8 ";
                      };
                      return " my-2 h-6 ";
              ...
              var tablePage = function (v) {
                  ...
                  return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_(""), UI_Utils.css("flex-1  w-3/4  overflow-visible  ") ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v1) {
                      return new Data_Maybe.Just(UI_Component_RootType.UpdateDataFromBlockChain.value);
                  }), UI_Utils.css("flex bg-gray-700 hover:bg-gray-900 text-white font-bold py-2 px-4 rounded") ])([ Halogen_HTML_Elements.div([ UI_Utils.css("bi bi-arrow-clockwise" + (function () {
                      ...
                      if (s.waitTx instanceof Data_Maybe.Nothing) {
                          return Halogen_HTML_Core.text("Refresh" + (function () {
                              if (s.lastTx instanceof Data_Maybe.Just) {
                                  return " LastTx: " + Data_Show.show(Network_Ethereum_Core_HexString.showHexString)(s.lastTx.value0);
                              };
              ...
              var optionText = function (title) {
                  return function (inputs) {
                      return function (pageState) {
                          return Halogen_HTML_Elements.div([ UI_Utils.css("cmdList " + (function () {
                              var $20 = Data_Eq.eq(UI_Component_RootType.eqSignature)(pageState)(s.currentOptionPage);
                              if ($20) {
                                  return "";
                              };
                              return "hidden";
                          })()) ])([ Halogen_HTML_Elements.span([ UI_Utils.css("text-xl p-2") ])([ Halogen_HTML_Core.text(title) ]), Halogen_HTML_Elements.div([ UI_Utils.css("cmdCard") ])([ Halogen_HTML_Elements.div([ UI_Utils.css("cmdLabel") ])(inputs) ]) ]);
                      };
                  };
              };
                          ...
                          return function (optionType) {
                              return function (group) {
                                  return Halogen_HTML_Elements.form([ UI_Utils.css("flex items-center py-2" + (function () {
                                      if (optionType instanceof UI_Component_RootType.Contract) {
                                          return " text-red-700 shadow-red-100 ";
                                      };
                                      if (optionType instanceof UI_Component_RootType.Action) {
                                      ...
                                      throw new Error("Failed pattern match at UI.Component.Root (line 170, column 65 - line 173, column 100): " + [ optionType.constructor.name ]);
                  ...
                  return function (startTitle) {
                      return function (startf) {
                          return function (inputs) {
                              return function (pageState) {
                                  return Halogen_HTML_Elements.div([ UI_Utils.css("cmdList " + (function () {
                                      var $25 = Data_Eq.eq(UI_Component_RootType.eqSignature)(pageState)(s.currentOptionPage);
                                      if ($25) {
                                          return "";
                                      };
                                      return "hidden";
                                      ...
                                      if (pageState instanceof UI_Component_RootType.Contract) {
                                          return UI_Utils.css("bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded");
                                      };
                                      if (pageState instanceof UI_Component_RootType.Action) {
              ...
              var optionPage = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_(""), UI_Utils.css("list-none flex-wrap p-4  place-content-stretch h-1/2  background-gradient-option rounded") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.ul([ UI_Utils.css("flex absolute"), Halogen_HTML_CSS.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.top(CSS_Size.px(45.0)))(function () {
                  return CSS_Geometry.left(CSS_Size.px(15.0));
              })) ])([ Halogen_HTML_Elements.li([  ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
                  return new Data_Maybe.Just(new UI_Component_RootType.ChangePage(UI_Component_RootType.Action.value));
              }), UI_Utils.css(toggle(UI_Component_RootType.Action.value)(s.currentOptionPage) + " relative px-6 bg-green-400 hover:bg-green-500 rounded-t-lg text-green-100 cursor-pointer ") ])([ Halogen_HTML_Core.text("Action") ]) ]), Halogen_HTML_Elements.li([  ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
                  return new Data_Maybe.Just(new UI_Component_RootType.ChangePage(UI_Component_RootType.Edit.value));
              }), UI_Utils.css(toggle(UI_Component_RootType.Edit.value)(s.currentOptionPage) + " relative px-6 bg-blue-400 hover:bg-blue-500 rounded-t-lg text-blue-100 bg-gray-200 cursor-pointer ") ])([ Halogen_HTML_Core.text("Edit Sharer") ]) ]), Halogen_HTML_Elements.li([  ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
                  return new Data_Maybe.Just(new UI_Component_RootType.ChangePage(UI_Component_RootType.Contract.value));
              }), UI_Utils.css(toggle(UI_Component_RootType.Contract.value)(s.currentOptionPage) + "px-6 bg-red-400  hover:bg-red-500 rounded-t-lg text-red-100 bg-gray-200 cursor-pointer ") ])([ Halogen_HTML_Core.text("Contract") ]) ]) ]) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ optionGroup("Distribute to all sharers")("Distribute")(UI_Component_RootType.Distribute.value)([ optionInput("Save Amount (Int)")(UI_Component_RootType.InputSaveAmount.value)(ElemAmount.value) ])(UI_Component_RootType.Action.value) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ optionGroup("Add Sharer")("Add Sharer")(UI_Component_RootType.SetNewSharer.value)([ optionInput("Sharer Address")(UI_Component_RootType.InputSetNewSharer.value)(ElemAddress.value) ])(UI_Component_RootType.Edit.value), optionGroup("Set Sharer Volume")("Set Volume")(UI_Component_RootType.SetShareVolume.value)([ optionInput("Sharer Address")(UI_Component_RootType.InputSetSahreAddress.value)(ElemAddress.value), optionInput("Sharer Volume (decimals 2)")(UI_Component_RootType.InputSetSahreVolume.value)(ElemAmount.value) ])(UI_Component_RootType.Edit.value), optionGroup("Remove Sharer")("Remove Sharer")(UI_Component_RootType.SetRemoveSharer.value)([ optionInput("Sharer Address")(UI_Component_RootType.InputRemoveAddress.value)(ElemAddress.value), optionInput("KeyIn Current Sharer Volume")(UI_Component_RootType.InputRemoveVolume.value)(ElemAmount.value) ])(UI_Component_RootType.Edit.value) ])([ optionText("DistContract Address")([ (function () {
                  if (s.contractAddress instanceof Data_Maybe.Just) {
                      return Halogen_HTML_Core.text(Data_Show.show(Network_Ethereum_Core_Signatures.addressShow)(s.contractAddress.value0));
                  };
              ...
              var showPage = function (v) {
                  return function (v1) {
                      if (v instanceof Data_Maybe.Just && (v1 instanceof Data_Maybe.Just && Data_Eq.eq(Network_Ethereum_Core_Signatures.addressEq)(v.value0)(v1.value0))) {
                          return Halogen_HTML_Elements.div([ UI_Utils.css("flex h-full w-full min-h-screen-sans-3-rem") ])([ optionPage, tablePage("") ]);
                      };
                      if (v instanceof Data_Maybe.Just && (v1 instanceof Data_Maybe.Just && Data_Eq.notEq(Network_Ethereum_Core_Signatures.addressEq)(v.value0)(v1.value0))) {
                          return Halogen_HTML_Elements.div([ UI_Utils.css("flex h-full w-full min-h-screen-sans-3-rem") ])([ tablePage("full") ]);
                      };
                      return Halogen_HTML_Elements.div([ UI_Utils.css("hidden") ])([ tablePage("full") ]);
                  };
              };
              var findValue = function (v) {
                  if (v instanceof UI_Component_RootType.InputSaveAmount) {
                      if (s.saveAmount instanceof Data_Maybe.Just) {
                          return Data_Show.show(Data_Show.showInt)(UI_Component_RelayableNFT_Types.weiBigNumberToInt(s.saveAmount.value0)(s.decimals));
                      };
              ...
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("app-root"), UI_Utils.css("flex h-full w-full flex-wrap overflow-x-hidden overflow-y-hidden ") ])([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "header";
              }))(Data_Ord.ordUnit)(UI_Component_Header_Component["_header"])(Data_Unit.unit)(UI_Component_Header_Component.component(dictMonadAff)(dictMonadAsk)(s.busW))(Data_Unit.unit)(function ($40) {
                  return Data_Maybe.Just.create(UI_Component_RootType.HandleHeaderMessages.create($40));
          ...
          var $$eval = Halogen_Component.mkEval({
              handleAction: UI_Component_RootAction.handleAction(dictMonadAff)(dictMonadAsk),
              handleQuery: Halogen_Component.defaultEval.handleQuery,
              receive: Halogen_Component.defaultEval.receive,
              initialize: new Data_Maybe.Just(UI_Component_RootType.Initialize.value),
              finalize: Halogen_Component.defaultEval.finalize
          });
          return Halogen_Component.mkComponent({
              initialState: Data_Function["const"](UI_Component_RootState.initialState),
              render: render,
              "eval": $$eval
          });
      };
