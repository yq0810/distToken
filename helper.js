          ...
          return function (message) {
              var render = function (s) {
                  var stateText = (function () {
                      ...
                      throw new Error("Failed pattern match at UI.Component.Header.Component (line 116, column 17 - line 123, column 49): " + [ s.networkState.constructor.name ]);
                  })();
                  var connectHTML = function (v) {
                      ...
                      throw new Error("Failed pattern match at UI.Component.Header.Component (line 104, column 15 - line 109, column 53): " + [ v.constructor.name ]);
                  };
                  ...
                  var handleQuery = function (v) {
                      ...
                      if (v instanceof GiveBusW) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                              ...
                              $24.messages = new Data_Maybe.Just(v.value0);
                              return $24;
                          }))(function () {
                      ...
                      throw new Error("Failed pattern match at UI.Component.Header.Component (line 135, column 23 - line 141, column 26): " + [ v.constructor.name ]);
                  };
                  var handleAction = function (v) {
                      if (v instanceof Connect) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                                              ...
                                              Effect_Aff.launchAff_(Control_Lazy.fix(Effect_Aff.lazyAff)(function (loop) {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(500.0))(function () {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)((function () {
                                                          var v1 = Data_Functor.map(Data_Maybe.functorMaybe)(Network_Ethereum_Core_HexString.mkHexString)(UI_Config.getAddress(Data_Maybe.Nothing.value)(Data_Maybe.Just.create));
                                                          if (v1 instanceof Data_Maybe.Just) {
                                                              var v2 = Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Network_Ethereum_Core_Signatures.mkAddress)(v1.value0);
                                                              if (v2 instanceof Data_Maybe.Just) {
                                                                  return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Halogen_Query_EventSource.emit(emitter)(new OnConnected$prime(v2.value0)));
                                                              };
                                                              return Partial_Unsafe.unsafeCrashWith("Unable to parse address:" + Data_Show.show(Data_Maybe.showMaybe(Network_Ethereum_Core_Signatures.addressShow))(v2));
                                                          };
                                                          if (v1 instanceof Data_Maybe.Nothing) {
                                                              return Partial_Unsafe.unsafeCrashWith("wait connect");
                                                          };
                                                          throw new Error("Failed pattern match at UI.Component.Header.Component (line 153, column 23 - line 159, column 68): " + [ v1.constructor.name ]);
                                                      })())(function () {
                                                          return loop;
                                                      });
                                                  });
                              ...
                              throw new Error("Failed pattern match at UI.Component.Header.Component (line 147, column 13 - line 163, column 55): " + [ messages.constructor.name ]);
                          });
                      };
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Reader_Class.ask(Halogen_Query_HalogenM.monadAskHalogenM(dictMonadAsk)))(function (v1) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                  ...
                                  if (v1.maybeWeb3Provider instanceof Data_Maybe.Just) {
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Network_Ethereum_Web3_Types_Types.runWeb3(v1.maybeWeb3Provider.value0)(Network_Ethereum_Web3_Api.net_version)))(function (eNetID) {
                                          if (eNetID instanceof Data_Either.Left) {
                                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Disconnected.value);
                                          };
                                          if (eNetID instanceof Data_Either.Right) {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Class_Console.log(Effect_Class.monadEffectEffect)("network ID is " + eNetID.value0)))(function () {
                                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)((function () {
                                                      ...
                                                      if (eNetID.value0 === "80001") {
                                                          return ConnectedMumbai.value;
                                                      };
                                                      if (eNetID.value0 === "420123") {
                                                          return ConnectedCliquebait.value;
                                                      };
                                                      if (eNetID.value0 === "137") {
                                          ...
                                          throw new Error("Failed pattern match at UI.Component.Header.Component (line 172, column 17 - line 182, column 42): " + [ eNetID.constructor.name ]);
                                      });
                                  };
                                  throw new Error("Failed pattern match at UI.Component.Header.Component (line 168, column 26 - line 182, column 42): " + [ v1.maybeWeb3Provider.constructor.name ]);
                              })())(function (nextState) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                              ...
                              if (messages instanceof Data_Maybe.Just) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                                      ...
                                      $48.account = new Data_Maybe.Just(v.value0);
                                      return $48;
                                  }))(function () {
                              ...
                              throw new Error("Failed pattern match at UI.Component.Header.Component (line 186, column 13 - line 190, column 54): " + [ messages.constructor.name ]);
                          });
                      };
                      throw new Error("Failed pattern match at UI.Component.Header.Component (line 144, column 24 - line 190, column 54): " + [ v.constructor.name ]);
                  };
      ...
      return function (dictMonadAsk) {
          var render = function (v) {
              var tableHeadings = (function () {
                  ...
                  return [ "Address", "Volume (total: " + (Data_Show.show(Network_Ethereum_Core_BigNumber.showBigNumber)(v.totalShare) + ")"), "Expected Sharing (total: " + (balanceOfShow + ")") ];
              })();
              ...
              var tableEntry = function (entry) {
                  ...
                  var sharePercentageWith2fiexed = (function () {
                      var $19 = Data_Eq.notEq(Network_Ethereum_Core_BigNumber.eqBigNumber)(v.totalShare)(Data_Semiring.zero(Network_Ethereum_Core_BigNumber.semiringBigNumber));
                      if ($19) {
                  ...
                  var descriptionCell = [ td$prime("text-left")([ Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text(Data_Show.show(Network_Ethereum_Core_Signatures.addressShow)(view.sharer)) ]) ]), td$prime("text-left")([ Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text(Data_Show.show(Network_Ethereum_Core_BigNumber.showBigNumber)(view.shareVolume) + (" (" + (sharePercentageShow + " %)"))) ]) ]), td$prime("text-left")([ Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text("\u2252 " + amountShow) ]) ]) ];
                  ...
                  if (v1.value0 instanceof Data_Maybe.Just && v1.value1 instanceof Data_Maybe.Just) {
                      var $24 = Data_Eq.eq(Network_Ethereum_Core_Signatures.addressEq)(v1.value0.value0)(v1.value1.value0) || Data_Eq.eq(Network_Ethereum_Core_Signatures.addressEq)(view.sharer)(v1.value1.value0);
                      if ($24) {
              ...
              var responsiveLink$prime = function (loose) {
                  return function (text) {
                      return function (href) {
                          ...
                          throw new Error("Failed pattern match at UI.Component.RelayableNFT.Table (line 154, column 43 - line 159, column 102): " + [ href.constructor.name ]);
                      };
                  };
              };
              ...
              var historicalEntriesInfo = (function () {
                  ...
                  var backfillCaveat = (function () {
                      if ($43.bfs instanceof BackfillFinished && ($43.noNew && $43.noOld)) {
                          return new Data_Maybe.Just("No Have Sharer .");
                      };
                      if ($43.bfs instanceof BackfillRunning && ($43.noNew && $43.noOld)) {
                          return Data_Maybe.Just.create("No FOAM Lite events seen \u2013 searching chain history" + ellipsisOrBackfillPercentage($43.bfs.value0));
                      };
                      if ($43.bfs instanceof BackfillNeverStarted && ($43.noNew && $43.noOld)) {
                          return new Data_Maybe.Just("waiting to connect to Ethereum...");
                      };
                      if ($43.bfs instanceof BackfillErrored && ($43.noNew && $43.noOld)) {
                          return Data_Maybe.Just.create("No FOAM Lite events seen yet -- searching chain history failed: " + $43.bfs.value0);
                      };
                      if ($43.bfs instanceof BackfillRunning) {
                          return Data_Maybe.Just.create("Searching chain history for more FOAM Lite events" + ellipsisOrBackfillPercentage($43.bfs.value0));
                      };
                      if ($43.bfs instanceof BackfillErrored && $43.noOld) {
                  ...
                  throw new Error("Failed pattern match at UI.Component.RelayableNFT.Table (line 193, column 15 - line 195, column 38): " + [ backfillCaveat.constructor.name ]);
              })();
              ...
              var handleQuery = function (v) {
                  if (v instanceof InsertNewTableEntry) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $92.entries = Data_Array.cons(v.value0)(st.entries);
                          return $92;
                      }))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(new Data_Maybe.Just(v.value1));
                      });
                  ...
                  if (v instanceof InsertHistoricalTableEntry) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $97.historicalEntries = Data_Array.cons(v.value0)(st.historicalEntries);
                          return $97;
                      }))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(new Data_Maybe.Just(v.value1));
                      });
                  ...
                  if (v instanceof BackfillExtentsDetermined) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          ...
                          $102.backfillExtents = new Data_Maybe.Just(v.value0);
                          return $102;
                      }))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(new Data_Maybe.Just(v.value1));
                      });
                  ...
                  if (v instanceof TableUpdateUser) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $132.userAddress = new Data_Maybe.Just(v.value0);
                          return $132;
                      }))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(new Data_Maybe.Just(v.value1));
                      });
                  ...
                  if (v instanceof TableUpdateAdmin) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $137.adminAddress = new Data_Maybe.Just(v.value0);
                          return $137;
                      }))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(new Data_Maybe.Just(v.value1));
                      });
                  };
                  throw new Error("Failed pattern match at UI.Component.RelayableNFT.Table (line 257, column 23 - line 287, column 29): " + [ v.constructor.name ]);
              };
              return Halogen_Component.mkEval({
          ...
          return Effect_Aff.launchAff((function () {
              if (action instanceof Web3SetShareVolume) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)("send. " + (Data_Show.show(Network_Ethereum_Core_Signatures.addressShow)(action.value0) + (" " + (Data_Show.show(Network_Ethereum_Core_Signatures.addressShow)(action.value1) + (" " + Data_Show.show(Data_Show.showInt)(action.value2)))))))(function () {
                      ...
                      return Control_Bind.bind(Effect_Aff.bindAff)(Network_Ethereum_Web3_Types_Types.runWeb3(v.web3Provider)(Contracts_DistToken.setSharerVolume(txOpts)({
                          ...
                          throw new Error("Failed pattern match at UI.Component.Root (line 552, column 9 - line 556, column 52): " + [ ePollResult.constructor.name ]);
                      });
                  });
              };
              if (action instanceof Web3NewSharer) {
                  ...
                  return Control_Bind.bind(Effect_Aff.bindAff)(Network_Ethereum_Web3_Types_Types.runWeb3(v.web3Provider)(Contracts_DistToken.addSharer(txOpts)({
                      ...
                      throw new Error("Failed pattern match at UI.Component.Root (line 561, column 9 - line 565, column 52): " + [ ePollResult.constructor.name ]);
                  });
              };
              if (action instanceof Web3ChangeAdmin) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)("send change Admin. " + Data_Show.show(Network_Ethereum_Core_Signatures.addressShow)(action.value1)))(function () {
                      ...
                      return Control_Bind.bind(Effect_Aff.bindAff)(Network_Ethereum_Web3_Types_Types.runWeb3(v.web3Provider)(Contracts_DistToken.changeAdmin(txOpts)({
                          ...
                          throw new Error("Failed pattern match at UI.Component.Root (line 570, column 9 - line 574, column 52): " + [ ePollResult.constructor.name ]);
                      });
                  });
              };
              if (action instanceof Web3Distribute) {
                  ...
                  return Control_Bind.bind(Effect_Aff.bindAff)(Network_Ethereum_Web3_Types_Types.runWeb3(v.web3Provider)(Contracts_DistToken.distShares(txOpts)({
                      ...
                      throw new Error("Failed pattern match at UI.Component.Root (line 580, column 9 - line 584, column 52): " + [ ePollResult.constructor.name ]);
                  });
              };
              if (action instanceof Web3Withdraw) {
                  ...
                  return Control_Bind.bind(Effect_Aff.bindAff)(Network_Ethereum_Web3_Types_Types.runWeb3(v.web3Provider)(Contracts_DistToken.withdraw(txOpts)({
                      ...
                      throw new Error("Failed pattern match at UI.Component.Root (line 588, column 9 - line 592, column 52): " + [ ePollResult.constructor.name ]);
                  });
              };
              throw new Error("Failed pattern match at UI.Component.Root (line 546, column 5 - line 592, column 52): " + [ action.constructor.name ]);
          })());
      };
  };
  var mkWeb3Monitor = function (v) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)("getShareVolumeByAddress address " + Data_Show.show(Network_Ethereum_Core_Signatures.addressShow)(sharer)))(function () {
                          ...
                          if (ePollResult instanceof Data_Either.Right) {
                              return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)((function () {
                                  ...
                                  throw new Error("Failed pattern match at UI.Component.Root (line 672, column 11 - line 679, column 18): " + [ ePollResult.value0.constructor.name ]);
                              })());
                          };
                          throw new Error("Failed pattern match at UI.Component.Root (line 668, column 7 - line 679, column 18): " + [ ePollResult.constructor.name ]);
                      });
                  }));
              };
          };
                  ...
                  return Effect_Aff.launchAff(Control_Bind.bind(Effect_Aff.bindAff)(Network_Ethereum_Web3_Types_Types.runWeb3(web3Provider1)(Contracts_FungibleToken.balanceOf(txOpts)(Network_Ethereum_Web3_Types_Types.Latest.value)({
                      ...
                      if (ePollResult instanceof Data_Either.Right) {
                          return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)((function () {
                              ...
                              throw new Error("Failed pattern match at UI.Component.Root (line 630, column 11 - line 636, column 78): " + [ ePollResult.value0.constructor.name ]);
                          })());
                      };
                      throw new Error("Failed pattern match at UI.Component.Root (line 626, column 7 - line 636, column 78): " + [ ePollResult.constructor.name ]);
                  }));
              };
          };
      };
                  ...
                  return Control_Bind.bind(Effect_Aff.bindAff)(Network_Ethereum_Web3_Types_Types.runWeb3(web3Provider1)(Contracts_DistToken.owner(txOpts)(Network_Ethereum_Web3_Types_Types.Latest.value)))(function (ePollResult) {
                      ...
                      if (ePollResult instanceof Data_Either.Right) {
                          return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)((function () {
                              ...
                              throw new Error("Failed pattern match at UI.Component.Root (line 645, column 11 - line 649, column 64): " + [ ePollResult.value0.constructor.name ]);
                          })());
                      };
                      throw new Error("Failed pattern match at UI.Component.Root (line 641, column 7 - line 649, column 64): " + [ ePollResult.constructor.name ]);
                  });
              }));
          };
      };
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)("Find address " + Data_Show.show(Network_Ethereum_Web3_Solidity_UInt.showUIntN)(n)))(function () {
                              ...
                              if (ePollResult instanceof Data_Either.Right) {
                                  return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)((function () {
                                      ...
                                      throw new Error("Failed pattern match at UI.Component.Root (line 658, column 11 - line 663, column 48): " + [ ePollResult.value0.constructor.name ]);
                                  })());
                              };
                              throw new Error("Failed pattern match at UI.Component.Root (line 654, column 7 - line 663, column 48): " + [ ePollResult.constructor.name ]);
                          });
                      }));
                  };
              };
      ...
      return Effect_Aff.launchAff((function () {
          ...
          return Control_Bind.bind(Effect_Aff.bindAff)(Network_Ethereum_Web3_Types_Types.runWeb3(v.web3Provider)(Contracts_DistToken.getShareVolumeMap(txOpts)(Network_Ethereum_Web3_Types_Types.Latest.value)))(function (ePollResult) {
              ...
              throw new Error("Failed pattern match at UI.Component.Root (line 599, column 5 - line 621, column 88): " + [ ePollResult.constructor.name ]);
          });
      })());
  };
  var initialState = {
      ...
      return function (dictMonadAsk) {
          var render = function (s) {
              var tablePage = function (v) {
                  if (v === "full") {
                      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_(""), UI_Utils.css("w-full overflow-x-hidden overflow-visible lg:overflow-y-scroll") ])([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                          return "nftTable";
                  ...
                  return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_(""), UI_Utils.css("flex-1w-full lg:w-3/4 xl:w-3/4 overflow-x-hidden overflow-visible lg:overflow-y-scroll ") ])([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                      return "nftTable";
                  }))(Data_Ord.ordUnit)(UI_Component_RelayableNFT_Table["_nftTable"])(Data_Unit.unit)(UI_Component_RelayableNFT_Table.component(dictMonadAff)(dictMonadAsk))(Data_Unit.unit)(Data_Void.absurd) ]);
              };
              var optionButton = function (labelName) {
                  return function (startName) {
                      return function (inputf) {
                          return function (startf) {
                              return Halogen_HTML_Elements.div([ UI_Utils.css("flex items-center border-b border-teal-500 py-2") ])([ Halogen_HTML_Core.text(labelName), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Events.onValueInput(function ($308) {
                                  return Data_Maybe.Just.create(inputf($308));
                              }), UI_Utils.css("shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
                                  return new Data_Maybe.Just(startf);
                              }), UI_Utils.css("bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded") ])([ Halogen_HTML_Core.text(startName) ]) ]);
                          };
                      };
                  };
              };
              var optionPage = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_(""), UI_Utils.css("mb-0 list-none flex-wrap p-4  grid grid-cols-1 place-content-stretch h-1/2  background-gradient-option rounded") ])([ Halogen_HTML_Elements.span([ UI_Utils.css("text-2xl font-semibold inline-block py-1 px-2 uppercase rounded-full text-blue-600 bg-blue-200 uppercase last:mr-0 mr-1") ])([ Halogen_HTML_Core.text("Admin operations") ]), optionButton("New Sharer Address")("SetAddress")(InputSetNewSharer.create)(SetNewSharer.value), Halogen_HTML_Elements.span([ UI_Utils.css("text-xl p-2") ])([ Halogen_HTML_Core.text("Set Sharer Volume") ]), Halogen_HTML_Elements.div([ UI_Utils.css("flex items-center py-2") ])([ Halogen_HTML_Core.text("Set Sharer Address"), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Events.onValueInput(function ($309) {
                  return Data_Maybe.Just.create(InputSetSahreAddress.create($309));
              }), UI_Utils.css("shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline") ]) ]), Halogen_HTML_Elements.div([ UI_Utils.css("flex items-center py-2") ])([ Halogen_HTML_Core.text("Set Sharer Volume Number"), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Events.onValueInput(function ($310) {
                  return Data_Maybe.Just.create(InputSetSahreRate.create($310));
              }), UI_Utils.css("shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline") ]) ]), Halogen_HTML_Elements.div([ UI_Utils.css("flex items-center border-b border-teal-500 py-2") ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
                  return new Data_Maybe.Just(SetShareVolume.value);
              }), UI_Utils.css("bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded") ])([ Halogen_HTML_Core.text("Set Sharer Volume") ]) ]), Halogen_HTML_Elements.span([ UI_Utils.css("text-xl p-2") ])([ Halogen_HTML_Core.text("Distribute to all sharers") ]), optionButton("Save Amount Number")("Distribute")(InputSaveAmount.create)(Distribute.value), Halogen_HTML_Elements.span([ UI_Utils.css("text-2xl font-semibold inline-block py-3 px-2 uppercase rounded-full text-red-600 bg-red-200 uppercase last:mr-0 mr-1") ])([ Halogen_HTML_Core.text("Dangerous operations (WARRING)") ]), Halogen_HTML_Elements.div([ UI_Utils.css("flex items-center py-2 border-b border-red-500 ") ])([ Halogen_HTML_Core.text("withdraw token address"), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Events.onValueInput(function ($311) {
                  return Data_Maybe.Just.create(InputSetWithdrawToken.create($311));
              }), UI_Utils.css("appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
                  return new Data_Maybe.Just(WithdrawToken.value);
              }), UI_Utils.css("bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded") ])([ Halogen_HTML_Core.text("Withdraw") ]) ]), Halogen_HTML_Elements.div([ UI_Utils.css("flex items-center py-2") ])([ Halogen_HTML_Core.text("Change Admin Address"), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Events.onValueInput(function ($312) {
                  return Data_Maybe.Just.create(InputSetNewAdmin.create($312));
              }), UI_Utils.css("appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white") ]) ]), Halogen_HTML_Elements.div([ UI_Utils.css("flex items-center py-2") ])([ Halogen_HTML_Core.text("KeyIn [confirm]"), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Events.onValueInput(function ($313) {
                  return Data_Maybe.Just.create(InputSetConfirm.create($313));
              }), UI_Utils.css("appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white") ]) ]), Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
                  return new Data_Maybe.Just(SetNewAdmin.value);
              }), UI_Utils.css("bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded") ])([ Halogen_HTML_Core.text("SetAdmin") ]) ]) ]);
              ...
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("app-root"), UI_Utils.css("flex h-full w-full flex-wrap overflow-x-hidden") ])([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "header";
              }))(Data_Ord.ordUnit)(UI_Component_Header_Component["_header"])(Data_Unit.unit)(UI_Component_Header_Component.component(dictMonadAff)(dictMonadAsk)(s.busW))(Data_Unit.unit)(function ($314) {
                  return Data_Maybe.Just.create(HandleHeaderMessages.create($314));
          ...
          var handleAction = function (v) {
              if (v instanceof InputSetConfirm) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $146.confirm = new Data_Maybe.Just(v.value0);
                      return $146;
                  });
              };
              if (v instanceof InputSetWithdrawToken) {
                  ...
                  if (v1 instanceof Data_Maybe.Just && v1.value0 instanceof Data_Maybe.Just) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("InputSetNewSharer  OK : " + Data_Show.show(Network_Ethereum_Core_Signatures.addressShow)(v1.value0.value0)))(function () {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $151.withdrawToken = new Data_Maybe.Just(v1.value0.value0);
                              return $151;
                          });
                      });
                  };
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("InputSetNewSharer fail : " + Data_Show.show(Data_Show.showString)(v.value0)))(function () {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $156.withdrawToken = Data_Maybe.Nothing.value;
                          return $156;
                      });
                  });
              };
              if (v instanceof InputSetNewSharer) {
                  ...
                  if (v1 instanceof Data_Maybe.Just && v1.value0 instanceof Data_Maybe.Just) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("InputSetNewSharer  OK : " + Data_Show.show(Network_Ethereum_Core_Signatures.addressShow)(v1.value0.value0)))(function () {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $161.setNewSharer = new Data_Maybe.Just(v1.value0.value0);
                              return $161;
                          });
                      });
                  };
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("InputSetNewSharer fail : " + Data_Show.show(Data_Show.showString)(v.value0)))(function () {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $166.setNewSharer = Data_Maybe.Nothing.value;
                          return $166;
                      });
                  });
              };
              if (v instanceof InputSetNewAdmin) {
                  ...
                  if (v1 instanceof Data_Maybe.Just && v1.value0 instanceof Data_Maybe.Just) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("InputSetNewAdmin  OK : " + Data_Show.show(Network_Ethereum_Core_Signatures.addressShow)(v1.value0.value0)))(function () {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $171.setNewAdmin = new Data_Maybe.Just(v1.value0.value0);
                              return $171;
                          });
                      });
                  };
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("InputSetNewAdmin fail : " + Data_Show.show(Data_Show.showString)(v.value0)))(function () {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $176.setNewAdmin = Data_Maybe.Nothing.value;
                          return $176;
                      });
                  });
              };
              if (v instanceof InputSaveAmount) {
                  ...
                  if (v1 instanceof Data_Maybe.Just && (v1.value0 instanceof Data_Maybe.Just && v1.value0.value0 instanceof Data_Maybe.Just)) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("InputSaveAmount OK : " + Data_Show.show(Network_Ethereum_Core_BigNumber.showBigNumber)(v1.value0.value0.value0)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              var $181 = {};
                              for (var $182 in v2) {
                                  if ({}.hasOwnProperty.call(v2, $182)) {
                                      $181[$182] = v2[$182];
                                  };
                              };
                              $181.saveAmount = new Data_Maybe.Just(v1.value0.value0.value0);
                              return $181;
                          }))(function () {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("InputSaveAmount fail : " + Data_Show.show(Data_Show.showString)(v.value0)))(function () {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $187.saveAmount = Data_Maybe.Nothing.value;
                          return $187;
                      });
                  });
              };
              if (v instanceof InputSetSahreAddress) {
                  ...
                  if (v1 instanceof Data_Maybe.Just && v1.value0 instanceof Data_Maybe.Just) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("InputSetSahreAddress  1 OK : " + Data_Show.show(Network_Ethereum_Core_Signatures.addressShow)(v1.value0.value0)))(function () {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $192.setSharerAddress = new Data_Maybe.Just(v1.value0.value0);
                              return $192;
                          });
                      });
                  };
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("InputSetSahreAddress fail : " + Data_Show.show(Data_Show.showString)(v.value0)))(function () {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $197.setSharerAddress = Data_Maybe.Nothing.value;
                          return $197;
                      });
                  });
              };
                  ...
                  if (v1 instanceof Data_Maybe.Just) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("InputSetSahreRate  OK : " + Data_Show.show(Data_Show.showInt)(amount)))(function () {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $202.setSharerRate = new Data_Maybe.Just(amount);
                              return $202;
                          });
                      });
                  };
                  if (v1 instanceof Data_Maybe.Nothing) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("InputSetSahreRate fail : " + Data_Show.show(Data_Show.showString)(v.value0)))(function () {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $206.setSharerRate = Data_Maybe.Nothing.value;
                              return $206;
                          });
                      });
                  };
                  throw new Error("Failed pattern match at UI.Component.Root (line 329, column 9 - line 336, column 56): " + [ v1.constructor.name ]);
              };
                              ...
                              if (eNetProps instanceof Data_Either.Right) {
                                  ...
                                  if (v2 instanceof Data_Maybe.Nothing) {
                                      ...
                                      var toastableNetworksStr = (function () {
                                          var $215 = Data_Array["null"](toastableNetworks);
                                          if ($215) {
                                  ...
                                  if (v2 instanceof Data_Maybe.Just) {
                                      ...
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                          ...
                                          throw new Error("Failed pattern match at UI.Component.Root (line 366, column 29 - line 368, column 144): " + [ netMeta.constructor.name ]);
                                      })())(function () {
                                          var toastReadyNetworkName = (function () {
                                              ...
                                              throw new Error("Failed pattern match at UI.Component.Root (line 370, column 57 - line 372, column 72): " + [ netMeta.constructor.name ]);
                                          })();
                                          return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.subscribe(Halogen_Query_EventSource.effectEventSource(dictMonadAff)(function (emitter) {
                                              return function __do() {
                                  ...
                                  throw new Error("Failed pattern match at UI.Component.Root (line 350, column 67 - line 384, column 86): " + [ v2.constructor.name ]);
                              };
                              throw new Error("Failed pattern match at UI.Component.Root (line 348, column 19 - line 384, column 86): " + [ eNetProps.constructor.name ]);
                          });
                      };
                      throw new Error("Failed pattern match at UI.Component.Root (line 340, column 13 - line 384, column 86): " + [ v1.maybeWeb3Provider.constructor.name ]);
                  });
              };
              if (v instanceof SetShareVolume) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at UI.Component.Root (line 388, column 30 - line 390, column 80): " + [ v1.constructor.name ]);
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                              ...
                              if (address instanceof Data_Maybe.Just) {
                                  ...
                                  throw new Error("Failed pattern match at UI.Component.Root (line 396, column 17 - line 399, column 90): " + [ rate.constructor.name ]);
                              };
                              throw new Error("Failed pattern match at UI.Component.Root (line 393, column 13 - line 399, column 90): " + [ address.constructor.name ]);
                          });
                      });
                  });
              };
              if (v instanceof SetNewAdmin) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at UI.Component.Root (line 402, column 30 - line 404, column 80): " + [ v1.constructor.name ]);
                  })())(function (baseAddressGo) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              if (v instanceof SetNewSharer) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at UI.Component.Root (line 412, column 30 - line 414, column 80): " + [ v1.constructor.name ]);
                  })())(function (baseAddressGo) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          throw new Error("Failed pattern match at UI.Component.Root (line 416, column 13 - line 418, column 91): " + [ address.constructor.name ]);
                      });
                  });
              };
              ...
              if (v instanceof Distribute) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          throw new Error("Failed pattern match at UI.Component.Root (line 432, column 13 - line 435, column 85): " + [ amount.constructor.name ]);
                      });
                  });
              };
              if (v instanceof BalanceOf) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $256.balanceOf = Data_Maybe.Just.create(UI_Component_RelayableNFT_Types.bigNumberToFloat(Data_EuclideanRing.div(Network_Ethereum_Core_BigNumber.euclidianRingBigNumber)(v.value0)(UI_Component_RelayableNFT_Types.stringToBigNumber("10000000000000000"))) / 100.0);
                      return $256;
                  });
              };
              if (v instanceof ContractAdmin) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $260.contractAdmin = new Data_Maybe.Just(v.value0);
                      return $260;
                  }))(function () {
                      return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
                          return "nftTable";
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Class_Console.log(Effect_Class.monadEffectEffect)("Root init")))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Effect_Aff_Bus.make(Effect_Aff.monadEffectAff)))(function (messages) {
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $265.busR = new Data_Maybe.Just(v1.value0);
                              $265.busW = new Data_Maybe.Just(v1.value1);
                              return $265;
                          }))(function () {
                                              ...
                                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Network_Ethereum_Web3_Types_Types.runWeb3(v2.maybeWeb3Provider.value0)(Control_Bind.bind(Network_Ethereum_Web3_Types_Types.bindWeb3)(Network_Ethereum_Web3_Api.eth_blockNumber)(function (chainHeadBlockNumber) {
                                                  ...
                                                  if (eNetProps instanceof Data_Either.Right) {
                                                      ...
                                                      if (v3 instanceof Data_Maybe.Nothing) {
                                                          ...
                                                          var toastableNetworksStr = (function () {
                                                              var $273 = Data_Array["null"](toastableNetworks);
                                                              if ($273) {
                                                                  return "<looks like I was built without any artifact deployments... whoops...>";
                                                              };
                                                      ...
                                                      if (v3 instanceof Data_Maybe.Just) {
                                                          ...
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                                              ...
                                                              throw new Error("Failed pattern match at UI.Component.Root (line 479, column 19 - line 481, column 134): " + [ netMeta.constructor.name ]);
                                                          })())(function () {
                                                              var toastReadyNetworkName = (function () {
                                                                  if (netMeta instanceof Data_Maybe.Nothing) {
                                                                      return "Ethereum";
                                                                  ...
                                                                  throw new Error("Failed pattern match at UI.Component.Root (line 483, column 47 - line 485, column 62): " + [ netMeta.constructor.name ]);
                                                              })();
                                                      ...
                                                      throw new Error("Failed pattern match at UI.Component.Root (line 464, column 70 - line 506, column 76): " + [ v3.constructor.name ]);
                                                  };
                                                  throw new Error("Failed pattern match at UI.Component.Root (line 462, column 13 - line 506, column 76): " + [ eNetProps.constructor.name ]);
                                              });
                                          };
                                          throw new Error("Failed pattern match at UI.Component.Root (line 453, column 9 - line 506, column 76): " + [ v2.maybeWeb3Provider.constructor.name ]);
                                      });
                                  });
                              });
                          });
              ...
              if (v instanceof HandleHeaderMessages) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $303.web3Address = new Data_Maybe.Just(v.value0.value0);
                      return $303;
                  }))(function () {
                      return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
                          return "nftTable";
              ...
              throw new Error("Failed pattern match at UI.Component.Root (line 284, column 20 - line 530, column 83): " + [ v.constructor.name ]);
          };
